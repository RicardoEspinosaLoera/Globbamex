...
class CustomerController extends BaseController
{
    ...
    public function __construct(
        ...
        private readonly SubscriptionEmailRepositoryInterface   $subscriptionEmailRepo,
    ...
    {
        $subscription_list = $this->subscriptionEmailRepo->getListWhere(searchValue:$request['searchValue']);
    ...
    {
        $subscription = $this->subscriptionEmailRepo->getListWhere(searchValue:$request['searchValue'], dataLimit: 'all');
