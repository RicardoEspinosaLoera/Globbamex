...
use App\Enums\ViewPaths\Admin\BlogRoutes;
...
use App\Http\Controllers\Admin\Settings\PlanSettingsController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'sellers', 'as' => 'sellers.','middleware'=>['module:user_section']], function () {
        Route::controller(VendorController::class)->group(function (){
            ...
            Route::post(Vendor::VERIFIED[URI], 'updateVerified')->name('verified');
    ...
    Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
        ...
        Route::group(['prefix' => 'plan-settings', 'as' => 'plan-settings.', 'middleware' => ['module:system_settings']], function() {
            Route::controller(PlanSettingsController::class)->group(function() {
                Route::get(BusinessSettings::PLAN_VIEW[URI], 'index')->name('index')->middleware('actch');
                Route::post(BusinessSettings::PLAN_UPDATE[URI], 'update')->name('update');
            });
        });
    ...
    Route::group(['prefix' => 'blogs', 'as' => 'blogs.'], function () {
        Route::controller(BlogController::class)->group(function () {
            Route::get(BlogRoutes::INDEXBLOG['URI'], 'indexblog')->name('indexblog');
            Route::get(BlogRoutes::CREATEBLOG['URI'], 'createblog')->name('createblog');
            Route::post(BlogRoutes::STOREBLOG['URI'], 'storeblog')->name('storeblog');
            Route::get(BlogRoutes::SHOWBLOG['URI'] . '/{idshow}', 'show')->name('showblog');
            Route::get(BlogRoutes::EDITBLOG['URI'] . '/{idedit}', 'edit')->name('editblog');
            Route::post(BlogRoutes::UPDATEBLOG['URI'] . '/{idupdate}', 'update')->name('updateblog');
            Route::delete(BlogRoutes::DELETEBLOG['URI'] . '/{iddelete}', 'destroy')->name('destroyblog');
            
           // Route::get(BlogRoutes::PORTALBLOG['URI'], 'portalblog')->name('portalblog');
