...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode','guestCheck']], function () {
    ...
    Route::get('portal', 'WebController@portalblog')->name('portal');
    
    Route::get('blogs/{route}', 'WebController@showblog')->name('showblog');
    //Route::get('blog_two', 'WebController@blog_two')->name('blog_two');
    //Route::get('blog_three', 'WebController@blog_three')->name('blog_three');
