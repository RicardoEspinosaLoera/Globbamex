...
Route::post('stripe/webhook', 'Vendor\StripeWebhookController@handleWebhook')->name('cashier.webhook')->withoutMiddleware(\App\Http\Middleware\VerifyCsrfToken::class);
...
Route::group(['prefix' => 'vendor', 'as' => 'vendor.'], function () {
    ...
    Route::controller(SubscriptionController::class)->group(function() {
        Route::get(Auth::VENDOR_CHECKOUT_SUBSCRIPTION[URI], 'checkout')->name('checkout-subscription');
        Route::post(Auth::VENDOR_CHECKOUT_SUBSCRIPTION[URI], 'checkout_create');
        Route::group(['prefix' => 'stripe', 'as' => 'stripe.'], function() {
            Route::get(Auth::VENDOR_CHECKOUT_SUBSCRIPTION_SUCCESS[URI], 'success')->name('success');
        });
    });
    ...
    Route::group(['middleware' => ['seller']], function () {
        ...
        Route::group(['prefix' => 'profile', 'as' => 'profile.'], function () {
            Route::controller(ProfileController::class)->group(function () {
                ...
                Route::get(Profile::CHECKOUT_SUBSCRIPTION[URI], 'checkout')->name('checkout-subscription');
                Route::post(Profile::CHECKOUT_SUBSCRIPTION[URI], 'checkout_create');
                Route::group(['prefix' => 'stripe', 'as' => 'stripe.'], function() {
                    Route::get(Profile::CHECKOUT_SUBSCRIPTION_RETURN[URI], 'return')->name('return');
                });
            });
        });
        ...
        Route::group(['prefix' => 'videos', 'as' => 'videos.'], function() {
            Route::controller(VideoController::class)->group(function() {
                Route::get(Video::INDEX[URI], 'index')->name('index');
            });
        });
    });
});
