...
$("#general-section").click(function() {
    $("#password-section, #plan-section").removeClass("active");
...
$("#password-section").click(function() {
    $("#general-section, #plan-section").removeClass("active");
    $("#password-section").addClass("active");
    $('html, body').animate({
        scrollTop: $("#password-div").offset().top
    }, 2000);
});
$("#plan-section").click(function() {
    $("#general-section, #password-section").removeClass("active");
    $("#plan-section").addClass("active");
    $('html, body').animate({
        scrollTop: $("#plan-div").offset().top
    }, 2000);
});
