...
$('.select-plan').on('click',function() {
    ...
    $('.card-plan').removeClass('bg-secondary');
    $('.select-plan').text($(this).data('select'));
    $(this).text($(this).data('selected'));
    $('#plan-'+plan_id).addClass('bg-secondary');
    $('#input-plan').val(plan_id);
});
