                        ...
                        <form action="{{ route('admin.banner.update', [$banner['id']]) }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group @if($banner['banner_type']!='Main Banner') d-none @endif mb-3" id="banner-language">
                                        ...
                                        <select class="js-example-responsive form-control w-100" name="language">
                                            ...
                                            <option value="{{ $language['code'] }}" @if($language['code']==$banner->language) selected @endif>{{ ucfirst($language['name']) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
