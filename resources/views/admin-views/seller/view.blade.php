                    ...
                    <div class="row gy-3 flex-grow-1 w-100">
                        <div class="col-sm-6 col-xxl-3">
                            ...
                            <div class="pair-list">
                                ...
                                @if(!is_null($seller->shop) && !is_null($seller->shop->constancy))
                                <div>
                                    <span class="w-100">{{ translate('constancy') }}:</span>
                                    <img class="avatar avatar-170 rounded-0" src="{{ getValidImage(path: '/storage/app/public/shop/constancy/'.$seller?->shop->constancy) }}" alt="{{ translate('image') }}">
                                </div>
                                @endif
                            </div>
                        </div>
                        <div class="col-sm-6 col-xxl-3">
                            ...
                            <div class="pair-list">
                                ...
                                <div>
                                    <span class="key">{{ translate('gender') }}</span>
                                    <span>:</span>
                                    <span class="value">{{ $seller->gender }}</span>
                                </div>

                                <div>
                                    <span class="key">{{ translate('years21') }}</span>
                                    <span>:</span>
                                    <span class="value">{{ $seller->years21 }}</span>
                                </div>

                                @if(!is_null($seller->document))
                                <div>
                                    <span class="w-100">{{ translate('document_identity') }}:</span>
                                    <img class="avatar avatar-170 rounded-0" src="{{ getValidImage(path: '/storage/app/public/seller/document/'.$seller->document) }}" alt="{{ translate('image') }}">
                                </div>
                                @endif
                            </div>
                        </div>
