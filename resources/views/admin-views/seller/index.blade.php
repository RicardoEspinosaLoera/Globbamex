                            ...
                            @foreach($sellers as $key=>$seller)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('admin.sellers.verified') }}" method="post" id="seller-verified{{ $seller->id }}-form">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $seller->id }}">
                                            <label class="switcher mx-auto">
                                                <input type="checkbox" class="switcher_input toggle-switch-message" name="status" id="seller-verified{{ $seller->id }}" value="1" @if($seller->verified=='1') checked @endif data-modal-id="toggle-status-modal" data-toggle-id="seller-verified{{ $seller->id }}" data-on-image="loyalty-on.png" data-off-image="loyalty-off.png" data-on-title="{{ translate('seller_verified_title_on') }}" data-off-title="{{ translate('seller_verified_title_off') }}" data-on-message="<p>{{ translate('seller_verified_message_on') }}</p>" data-off-message="<p>{{ translate('seller_verified_message_off') }}</p>">
