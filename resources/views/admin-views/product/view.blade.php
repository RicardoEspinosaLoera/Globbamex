                    ...
                    <div class="row gy-3 flex-grow-1">
                        <div class="col-sm-6 col-xl-4">
                            ...
                            <div class="pair-list">
                                ...
                                <div>
                                    <span class="key text-nowrap text-capitalize">{{ translate('product_unit') }} &nbsp; :  {{ $product['unit']}}</span>
                        ...
                        <div class="col-sm-6 col-xl-4">
                            ...
                            <div class="pair-list">
                                ...
                                <p class="text-nowrap text-capitalize mb-0">{{ translate('prices') }}:</p>
                                @foreach($product['prices'] as $price)
                                <div>
                                    <span class="text-nowrap text-capitalize">{{ $price->qty_min.' - '.$price->qty_max.' '.translate('pieces') }}:</span>
                                    <span class="value">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $price->price), currencyCode: getCurrencyCode()) }}</span>
                                </div>
                                @endforeach
                                @else
                                <div>
                                    ...
                                    <span>:</span>
                                    <span class="value">{{setCurrencySymbol(amount: usdToDefaultCurrency(amount: $product->unit_price), currencyCode: getCurrencyCode()) }}</span>
                                </div>
                                @endif
