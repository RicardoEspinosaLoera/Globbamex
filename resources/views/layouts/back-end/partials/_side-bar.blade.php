            ...
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-brand-wrapper justify-content-between side-logo">
                    ...
                    <a class="navbar-brand" href="{{route('admin.dashboard.index')}}" aria-label="Front">
                      ...
                      <img class="navbar-brand-logo-mini for-web-logo max-h-30"
                             src="https://globbamex.com/storage/app/public/company/2024-04-16-661eec550e0d3.webp">
                    </a>
                    <button type="button"
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(Helpers::module_permission_check('promotion_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/'.BusinessSettings::ANNOUNCEMENT[URI])?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.blogs.indexblog')}}"
                                        ...
                                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/custom-role*')?'active':''}}">
                                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                               ...
                                               title="{{translate('employee_Role_Setup')}}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('employee_Role_Setup')}}</span>
                                            </a>
                                        </li>
                        ...
                        @if(Helpers::module_permission_check('system_settings'))
                            ...
                            <li class="navbar-vertical-aside-has-menu @if(Request::is('admin/videos/'.Video::LIST[URI])) active @endif">
                                <a class="nav-link" href="{{ route('admin.videos.list') }}" title="{{ translate('videos') }}">
                                    <span class="tio-video-camera nav-icon"></span>
                                    <span class="text-truncate">{{ translate('videos') }}</span>
                                </a>
                            </li>
