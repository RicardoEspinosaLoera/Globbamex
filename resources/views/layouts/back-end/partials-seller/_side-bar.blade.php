            ...
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="nav-item @if(Request::is('vendor/videos*')) scroll-here @endif">
                            <small class="nav-subtitle">{{ translate('videos') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        <li class="navbar-vertical-aside-has-menu {{Request::is('vendor/videos*')?'active':''}}">
                            <a href="{{ route('vendor.videos.index') }}" class="js-navbar-vertical-aside-menu-link nav-link">
                                <i class="tio-video-camera nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate text-capitalize">{{ translate('videos') }}</span>
                            </a>
                        </li>
                    </ul>
                </div>
