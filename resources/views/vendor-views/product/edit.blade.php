...
<div class="content container-fluid">
    <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
        <h2 class="h1 mb-0 d-flex align-items-center gap-2">
            <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/inhouse-product-list.png') }}" alt=""> {{ translate('product_Edit') }}
        </h2>
    </div>

    <form class="product-form text-start" action="{{route('vendor.products.update',$product->id)}}" method="post" enctype="multipart/form-data" id="product_form">
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="{{ $language != 'en'? 'd-none':''}} form-system-language-form" id="{{ $language}}-form">
                    <div class="form-group">
                        <label class="title-color" for="{{ $language}}_name">{{ translate('product_name') }} ({{strtoupper($language) }})</label>
                        <input type="text" {{ $language == 'en'? 'required':''}} name="name[]" id="{{ $language}}_name" value="{{ $translate[$language]['name']??$product['name']}}" class="form-control" placeholder="{{ translate('new_Product') }}" required>
                    </div>
                    <input type="hidden" name="lang[]" value="{{ $language}}">
                    <div class="form-group pt-4">
                        <label class="title-color">{{ translate('description') }} ({{strtoupper($language) }})</label>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-multiple js-states js-example-responsive form-control action-get-request-onchange" name="category_id" id="category_id" data-url-prefix="{{ url('/vendor/products/get-categories?parent_id=') }}" data-element-id="sub-category-select" data-element-type="select">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-multiple js-states js-example-responsive form-control action-get-request-onchange" name="sub_category_id" id="sub-category-select" data-id="{{ $product['sub_category_id'] }}" data-url-prefix="{{ url('/vendor/products/get-categories?parent_id=') }}" data-element-id="sub-sub-category-select" data-element-type="select">
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-multiple js-states js-example-responsive form-control" data-id="{{ $product['sub_sub_category_id'] }}" name="sub_sub_category_id" id="sub-sub-category-select">
                            </select>
                        </div>
                    </div>
                    @if($brandSetting)
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label class="title-color d-flex justify-content-between gap-2">
                                <span class="d-flex align-items-center gap-2">{{ translate('product_SKU') }}
                                ...
                                <span class="style-one-pro cursor-pointer user-select-none text--primary action-onclick-generate-number" data-input="#generate_number">{{ translate('generate_code') }}</span>
                            </label>

                            <input type="text" id="generate_number" name="code" class="form-control" value="{{ $product['code'] }}" placeholder="{{translate('123412')}}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <label class="title-color d-flex align-items-center gap-2">{{ translate('search_tags') }}
                            ...
                            <input type="text" class="form-control" name="tags" value="@foreach($product['tags'] as $tag) {{$tag->tag.','}} @endforeach" data-role="tagsinput">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row align-items-end">
                    <div class="form-group col-12">
                        <label class="title-color" for="type_price">{{ translate('type_price') }}</label>
                        <select name="type_price" class="form-control" required id="type_price">
                            <option value="1" @if($product->type_price=='1') selected @endif>{{ translate('unit_price') }}</option>
                            <option value="2" @if($product->type_price=='2') selected @endif>{{ translate('quantity_price') }}</option>
                        </select>
                    </div>

                    <div class="col-12 @if($product->type_price!='1') d-none @endif" id="container_unit_price">
                        <div class="row">
                            <div class="form-group col-lg-6 col-md-6 col-12">
                                <div class="d-flex gap-2">
                                    <label class="title-color">{{ translate('unit_price') }} ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</label>
                                ...
                                <input type="number" min="0" step="0.01" placeholder="{{ translate('unit_price') }}" name="unit_price" class="form-control" value={{ usdToDefaultCurrency($product['unit_price']) }} required>
                            </div>

                            <div class="form-group col-lg-6 col-md-6 col-12" id="minimum_order_qty">
                                <div class="d-flex gap-2">
                                ...
                                <input type="number" min="1" value="{{ $product['minimum_order_qty'] }}" step="1" placeholder="{{ translate('minimum_order_quantity') }}" name="minimum_order_qty" class="form-control" required>
                            </div>
                        </div>
                    </div>

                    <div class="col-12 @if($product->type_price!='2') d-none @endif" id="container_quantity_price">
                        <button type="button" class="btn btn--primary mr-2 mb-3" onclick="addPrice('{{ translate('minimum_quantity') }}', '{{ translate('maximum_quantity') }}', '{{ translate('unit_price') }}', '{{ getCurrencySymbol(currencyCode: getCurrencyCode()) }}');">{{ translate('add') }}</button>
                        <button type="button" class="btn btn-danger d-none mb-3" onclick="removePrice();" id="remove_price">{{ translate('remove') }}</button>

                        <div class="row">
                            <div class="col-12" id="price_elements">
                                @foreach($product['prices'] as $price)
                                <div class="row">
                                    <div class="form-group col-lg-4 col-md-4 col-12">
                                        <label class="title-color mb-2">{{ translate('minimum_quantity') }}</label>
                                        <input type="text" name="prices[{{ $loop->index }}][qty_min]" class="form-control @if($loop->index==0) integer-positive @else bg-light @endif" placeholder="{{ translate('minimum_quantity') }}" required @if(!$loop->first) readonly @endif min="1" value="{{ $price->qty_min }}" data-index="{{ $loop->index }}" id="{{ 'prices_qty_min_'.$loop->index }}">
                                    </div>

                                    <div class="form-group col-lg-4 col-md-4 col-12">
                                        <label class="title-color mb-2">{{ translate('maximum_quantity') }}</label>
                                        <input type="text" name="prices[{{ $loop->index }}][qty_max]" class="form-control integer-positive" placeholder="{{ translate('maximum_quantity') }}" required min="1" value="{{ $price->qty_max }}" data-index="{{ $loop->index }}" id="{{ 'prices_qty_max_'.$loop->index }}">
                                    </div>

                                    <div class="form-group col-lg-4 col-md-4 col-12">
                                        <label class="title-color mb-2">{{ translate('unit_price') }} ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</label>
                                        <input type="text" name="prices[{{ $loop->index }}][price]" class="form-control min-decimal" placeholder="{{ translate('unit_price') }}" required min="0" value="{{ $price->price }}" data-index="{{ $loop->index }}" id="{{ 'prices_price_'.$loop->index }}">
                                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 d-none">
                        <div class="form-group">
                            <div class="d-flex gap-2">
                                <label class="title-color">{{ translate('purchase_price') }} ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }}) </label>
                            ...
                            <input type="number" min="0" step="0.01" placeholder="{{ translate('purchase_price') }}" name="purchase_price" class="form-control" value={{ usdToDefaultCurrency($product['purchase_price']) }} required>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="quantity">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="{{ $product['current_stock'] }}" step="1" placeholder="{{ translate('quantity') }}" name="current_stock" id="current_stock" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="{{ $product->discount_type=='flat'?usdToDefaultCurrency($product->discount): $product->discount}}" step="0.01" placeholder="{{ translate('ex: 5') }}" name="discount" id="discount" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="{{ $product->tax ?? 0 }}" step="0.01" placeholder="{{ translate('tax') }}" name="tax" id="tax" class="form-control" required>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="shipping_cost">
                        <div class="form-group">
                            <div class="d-flex gap-2">
                                <label class="title-color">{{ translate('shipping_cost') }} ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</label>
                            ...
                            <input type="number" min="0" value="{{usdToDefaultCurrency($product->shipping_cost) }}" step="1" placeholder="{{ translate('shipping_cost') }}" name="shipping_cost" class="form-control" required>
                        </div>
                    </div>
        ...
        <div class="card mt-3 rest-part physical_product_show">
            ...
            <div class="card-body">
                <div class="row align-items-end">
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="mb-3 d-flex align-items-center gap-2">
                                <label class="mb-0 title-color">{{ translate('select_colors') }} :</label>
                                <label class="switcher">
                                    <input type="checkbox" class="switcher_input" id="product-color-switcher" name="colors_active" {{count($product['colors'])>0?'checked':''}}>
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                            ...
                            <select class="js-example-basic-multiple js-states js-example-responsive form-control color-var-select" name="colors[]" multiple="multiple" id="colors-selector" {{ count($product['colors'])>0?'':'disabled' }}>
                                ...
                                <option value={{ $color->code }} {{in_array($color->code,$product['colors'])?'selected':''}}>{{ $color['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="choice_attributes" class="pb-1 title-color">{{ translate('select_attributes') }} :</label>
                            ...
                            <div>
                                <div class="custom_upload_input">
                                    ...
                                    <div class="img_area_with_preview position-absolute z-index-2">
                                        <img id="pre_img_viewer" class="h-auto aspect-1 bg-white  " alt="" src="{{ getValidImage(path:'storage/app/public/product/thumbnail/'.$product->thumbnail,type:'backend-product') }}">
                                    </div>
                                ...
                                <p class="text-muted mt-2">{{ translate('image_format') }} : {{ "Jpg, png, jpeg, webp" }} <br>{{ translate('image_size') }} : {{ translate('max') }} {{ "2 MB" }}</p>
                            </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-2 mb-2">
                                ...
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" title="{{ translate('add_color_wise_product_images_here') }}.">
                                    <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}" alt="">
                                </span>
                            </div>
                                ...
                                <div class="row g-2" id="additional_Image_Section">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <div class="custom_upload_input custom-upload-input-file-area position-relative border-dashed-2 aspect-1">
                                            ...
                                            <a class="delete_file_input_css btn btn-outline-danger btn-sm square-btn" href="{{ route('vendor.products.delete-image',['id'=>$product['id'],'name'=>$photo]) }}">
                                                <i class="tio-delete"></i>
                                            </a>

                                            <div class="img_area_with_preview position-absolute z-index-2 border-0">
                                                <img id="additional_Image_{{ $unique_id }}" alt="" class="h-auto aspect-1 bg-white  " src="{{ getValidImage(path:'storage/app/public/product/'.$photo,type: 'backend-product') }}">
                                            </div>
                                            <div class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                <div class="d-flex flex-column justify-content-center align-items-center">
                                                    <img alt="" src="{{ dynamicAsset(path: 'public/assets/back-end/img/icons/product-upload-icon.svg') }}" class="w-75">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <div class="custom_upload_input custom-upload-input-file-area position-relative border-dashed-2 aspect-1">
                                            <a class="delete_file_input_css btn btn-outline-danger btn-sm square-btn" href="{{ route('vendor.products.delete-image',['id'=>$product['id'],'name'=>$photo->image_name,'color'=>'null']) }}">
                                                <i class="tio-delete"></i>
                                            </a>

                                            <div class="img_area_with_preview position-absolute z-index-2 border-0">
                                                <img id="additional_Image_{{ $unique_id }}" alt="" class="h-auto aspect-1 bg-white  " src="{{ getValidImage(path: 'storage/app/public/product/'.$photo->image_name,type:'backend-product')}}">
                                            </div>
                                            <div class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                <div class="d-flex flex-column justify-content-center align-items-center">
                                                    <img alt="" src="{{ dynamicAsset(path: 'public/assets/back-end/img/icons/product-upload-icon.svg') }}" class="w-75">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <div class="custom_upload_input position-relative border-dashed-2 aspect-1">
                                            <input type="file" name="images[]" class="custom-upload-input-file action-add-more-image" data-index="1" data-imgpreview="additional_Image_1" accept=".jpg, .webp, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" data-target-section="#additional_Image_Section">
        ...
        <div class="card mt-3 rest-part">
            ...
            <div class="card-body">
                ...
                <input type="text" value="{{ $product['video_url']}}" name="video_url" placeholder="{{ translate('ex') }} : https://www.youtube.com/embed/5R06LRdUCSE" class="form-control" required>
            </div>
        </div>
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="form-group w-100">
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    <div>
                                        <label class="title-color" for="meta_Image">{{ translate('meta_Image') }}</label>
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2 d-flex">
                                            <img id="pre_meta_image_viewer" class="h-auto aspect-1 bg-white" alt="" src="{{ getValidImage(path:'storage/app/public/product/meta/'.$product['meta_image'],type: 'backend-banner') }}">
                                        </div>
                                        <div class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                <img alt="" src="{{ dynamicAsset(path: 'public/assets/back-end/img/icons/product-upload-icon.svg') }}" class="w-75">
