                                ...
                                <div class="rtl">
                                    <label class="custom-control custom-checkbox m-0 d-flex">
                                        ...
                                        <span class="custom-control-label">
                                            <span>{{ translate('i_agree_to_Your') }}</span> <a class="font-size-sm text-primary text-force-underline" target="_blank" href="{{ route('privacy-policy') }}">{{ translate('privacy_policy') }}</a> | <a class="font-size-sm text-primary text-force-underline" target="_blank" href="{{ route('terms') }}">{{ translate('terms_and_condition') }}</a>
                                        </span>
                                    </label>
                                </div>
                            </div>
