                                                        ...
                                                        <div class="col-12 position-relative">
                                                            <a href="{{route('shopView',['id'=>$product->seller->id])}}" class="d-block">
                                                                <div class="d-flex __seller-author align-items-center">
                                                                    ...
                                                                    <div class="ms-2 w-0 flex-grow d-flex align-items-center">
                                                                        <h6 class="font-bold __text-16px">{{$product->seller->shop->name}}</h6>
                                                                        @if($product->seller->verified=='1')
                                                                        <img src="{{ asset('/public/assets/front-end/img/icons/verified.png') }}" class="verified-img" data-toggle="tooltip" data-placement="top" title="{{ translate('verified') }}">
                                                                        @endif
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="d-flex">
                                        @foreach($product['prices'] as $price)
                                            <div class="d-flex flex-column mr-3 mb-2">
                                                <span class="font-weight-normal small">{{ $price->qty_min }} - {{ $price->qty_max }} {{ translate('pieces') }}</span>
                                                <span class="font-weight-normal text-accent d-flex align-items-end gap-2">
                                                    {!! getPriceRangeWithDiscount(product: $product, amount: $price->price) !!}
                                                </span>
                                            </div>
                                        @endforeach
                                    </div>
