...
<div class="__floating-btn">
    ...
    @if(isset($whatsapp['status']) && $whatsapp['status'] == 1 )
        <div class="wa-widget-send-button">
            <a href="https://wa.me/{{ $whatsapp['phone'] }}?text=Hola%20en%20que%20podemos%20ayudarte?" target="_blank">
...
<script src="//code.tidio.co/an3txjsbqwosjmvrjxkr1ciz6axkqgze.js" async></script>
</body>
</html>
