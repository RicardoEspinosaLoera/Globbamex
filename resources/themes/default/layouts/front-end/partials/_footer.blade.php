<div class="__inline-9 rtl">
    ...
    <footer class="page-footer font-small mdb-color rtl">
            ...
            <div class="container text-center __pb-13px">
                ...
                <div
                    ...
                    <div class="col-md-3 footer-web-logo text-center text-md-start ">
                        ...
                        @if((isset($web_config['ios']) || isset($web_config['android'])) && ($web_config['ios']['status'] || $web_config['android']['status']))
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="row">
                                    <div class="col-12 start_address ">
                                        @if(!is_null(getWebConfig(name: 'company_phone')) && !empty(getWebConfig(name: 'company_phone')))
                                        <div class="">
                                            <a class="widget-list-link" href="{{ 'tel:'.getWebConfig(name: 'company_phone') }}">
                                                <span class="">
        ...
        <div class="bg-white-overlay-50">
            <div class="container">
                <div class="d-flex flex-wrap end-footer footer-end last-footer-content-align">
                    <div class="mt-3">
                        <p class="text-align-direction __text-16px">Globbamex {{ $web_config['copyright_text']->value }}</p>
                    </div>
                    <div
                        class="max-sm-100 justify-content-center d-flex flex-wrap mt-md-3 mt-0 mb-md-3 text-align-direction">
                        @if(isset($web_config['social_media']))
        ...
        @php($cookie = isset($web_config['cookie_setting']) ? json_decode($web_config['cookie_setting']['value'], true):null)
