<?php return array (
  ...
  'Upload product images' => '製品像をアップロードする',
  'ratio' => 'Ratio',
  'Upload thumbnail' => 'サムネイルアップロードする',
  'Variation' => '変化',
  'Choice Title' => '選択肢のタイル',
  'Variant' => '変異',
  'Variant Price' => 'Variant Price',
  'SKU' => 'SKU',
  'Enter choice values' => '選択を力してください',
  'Banner' => 'バナー',
  'add_main_banner' => 'メインバーの加',
  'add_secondary_banner' => '追加 二次 バー',
  ...
  'Marketing_Section' => 'マーケティング セクション',
  'list' => 'List',
  'withdraws' => 'Withdraws',
  'Order#' => '注文＃',
  'Add_new' => 'しく追加す',
  ...
  'Meta_image' => 'メタイメージ',
  'Youtube video link' => 'Youtubeデオリンク',
  'optional please provide embed link not direct link' => 'Optional  please provide embed link not direct link',
  'Upload_product_images' => '製品画像のアップロド',
  'ratio 1:1' => 'Ratio 1:1',
  'Upload_thumbnail' => 'ップロード サムネイル',
  'new' => 'New',
  'Seller_details' => '販売者の詳細',
  ...
  'If sales commission is disabled here the system default commission will be applied' => 'こで販売数料が無効になってい場合は、シテムのデフォルトの手料が適用さます',
  'Commission' => '手数料',
  'GST Number' => 'GST号',
  'If GST number is disabled here it will not show in invoice' => 'こで GST 番号が効にっている場合、請求書は表示されません',
  'Number' => '番号',
  'Welcome_message' => 'ようこそメッージ',
  'Overall_statistics' => '全体的な統計',
  'Today s Statistics' => '今日の計',
  ...
  'click' => 'Click',
  'here' => 'Here',
  'Select Country code' => '国コードを選択してだい',
  ...
  'checkout' => 'Checkout',
  'Sign_in_First_to_Apply_Coupon' => 'サインインて初めてーポンを適する',
  'phone' => 'Phone',
  'Enter_email_address_or_phone_number' => '電メールアレスまたは電話番号を入力してくだい',
  ...
  'Product_Management' => '製品 管理',
  'Business_Section' => 'Business Section',
  'user_Section' => 'User Section',
  'Support_Section' => 'サポート クシン',
  'Business_Settings' => 'ビジネス 設定',
  'Web_&_App_Settings' => 'ウェ & プリ 設定',
  'Report_&_Analytics' => 'レポート & ',
  'Employee_Section' => '員 セクション',
  ...
  'send' => 'Send',
  'Your Message Send Successfully' => 'メッセージが正常に信されました',
  'Expand menu' => 'メニューを展る',
  'view_more' => 'View more',
  'select_shipping_method_first' => 'Select shipping method first',
  'Shipping Address Choose' => '配送先住所を選てください',
  'Admin or Employee Login' => '管理者まは従業員のログイ',
  ...
  'Search_by_Attribute_Name' => '属性によ検索',
  'Are_you_sure_to_delete_this' => 'これ削除してもよろしいでか',
  'You_will not_be_able_to_revert_this' => 'これを元に戻すことできませ',
  'Yes' => 'はい',
  'delete_it' => 'Delete it',
  'Attribute_deleted_successfully' => '性 削除 成功',
  'Search_by_Banner_Type' => 'バナーの類で検索',
  'Banner_published_successfully' => 'ナー 公開 成功',
  'Banner_unpublished_successfully' => 'Banner unpublished successfully',
  'Are_you_sure_delete_this_banner' => 'このバナーを削しよろしいですか',
  'You_will_not_be_able_to_revert_this' => 'You will not be able to revert this',
  'Banner_deleted_successfully' => 'バナー 削除 成功',
  'Main_Banner_updated_Successfully' => 'Main Banner updated Successively',
  'Secondary_Banner_updated_Successfully' => 'Secondary Banner updated Successively',
  'Popup_Banner_updated_Successfully' => 'ポッップ バナー 更新 成功ました',
  'Ex' => '元',
  'LUX' => 'ルクス',
  'You_will_not_be_able_to_revert_this!' => 'これを元に戻すことできません!',
  'Brand_deleted_successfully' => 'Brand deleted successfully',
  'Brands' => 'ランド',
  'Are_you_sure_delete_this_brand' => 'このブンドを削除してよしいすか',
  'Are_you_sure' => 'Are you sure',
  'Category_deleted_Successfully.' => 'テゴリ 削除 成功しまた。',
  'Sub_Category' => 'ブカテゴリー',
  'Search_by_Sub_Category' => 'サブカゴリーで検索',
  'Are_you_sure_to_delete_this_sub_category' => 'このサブカテゴリを削除するの確実で',
  'Sub_Category_deleted_Successfully.' => 'サブテゴの削除に成功しまた',
  'New_Sub_Sub_Category' => '新しいサブサブカテゴリ',
  'Search_by_Sub_Sub_Category' => 'Search by Sub Sub Category',
  'You_wont_be_able_to_revert_this!' => 'これを元すことはできません!',
  ...
  'Request' => 'Request',
  'Earning statistics for business analytics' => 'ビジネス分析のた統計の取得',
  'This Year Earning' => '今年の稼ぎ',
  'Your Earnings' => 'Your Earnings',
  'Commission Given' => 'Commission Given',
  'Update your bank info first!' => 'まず行報を更新してください。',
  'Order Details' => '注詳細',
  'Order details' => '注文詳細',
  'Print invoice' => '請求書を印刷る',
  'Q' => 'Q',
  'Contact info' => '連絡先情報',
  'Status Change successfully' => 'テータ変更が成功しました',
  'Yes Change it!' => 'Yes  Change it!',
  'Order is already delivered You can not change it !!' => 'ご注文はすでに配送されており、更するこはできませ!!',
  'Status Change successfully !' => 'Status Change successfully !',
  'Product List' => '製品リスト',
  'Status updated successfully' => 'ステースが正常に更されました',
  'Status updated failed. Product must be approved' => 'ステータスの新に失しました。',
  ...
  'Remove' => 'り除く',
  'Instructions' => '明書',
  'Download the format file and fill it with proper data' => 'フォーマットフイルをダウンロードし適切なデータを入力し',
  'You can download the example file to understand how the data must be filled' => 'サプ ファイルをダウロードすると、データどのよに入力する必要があるを理解できす。',
  'Once you have downloaded and filled the format file upload it in the form below and submit' => 'フォーマットァイルをダンロードして記入した、以下フォームにアップローして送信してくさい',
  'After uploading products you need to edit them and set products images and choices' => '品をアップロードした、商品を編集し、商画像と選択肢を設定す要があります',
  'You can get brand and category id from their list please input the right ids' => 'リストからブンドとカテゴリ ID を得できます。正しい ID を力してください。',
  'Import Products File' => '品ファイルのインポート',
  'Download Format' => 'ウンロド形式',
  'Review List' => 'レビュー一覧',
  'Product reviews' => '商品レビュ',
  'star' => 'Star',
  'Current Stock' => '現在在庫',
  'Available color' => '利用可な色',
  'Product Image' => '製品イメージ',
  'Reviewer' => '査読者',
  'Chatting List' => 'Chatting List',
  'edit' => 'Edit',
  'Bank info' => 'Bank info',
  'Edit Bank Info' => '銀行情報の集',
  'Bank Name' => '銀行',
  ...
  'Address' => '住所',
  'Ratio' => '比率',
  'Shipping Method deleted successfully' => '送方が正常に削除されました',
  'Once deleted you will not be able to recover this' => '一度削除すると元戻ことはできません',
  'warning' => 'Warning',
  'FAQ' => 'よくある質問',
  'frequently_asked_question' => 'Frequently asked question',
  'Track Order Result' => '注文結果跡',
  'My Wishlists' => '私のウィッシュリスト',
  'Image ratio should be' => '画比率は次のとおりです',
  'add_new_address' => 'しアドレスを追加',
  'permanent' => 'Permanent',
  'Office' => 'オフィス',
  'State' => '州',
  'ADDRESSES' => '住',
  'My Support Tickets' => 'のサポートチケット',
  ...
  'add_new_ticket' => '新しいチケットを加',
  'Welcome To' => 'ようこそ',
  'Previous' => '前の',
  'All Brands Page' => 'すてのブランページ',
  'items found' => 'Items found',
  'All Category Page' => 'All Category Page',
  'Select your desire category' => 'ご希望のテゴリを選択てください',
  'View Products' => '品を見る',
  'Contact Us' => 'お問い合わせ',
  'Contact Number' => '連絡番号',
  'Short title' => 'いタトル',
  'Privacy policy' => 'プライバシーポリー',
  'Terms & Conditions' => '用規約',
  'Terms and Condition' => '利用規約',
  'About Us' => '私たちについて',
  'About Our Company' => '当について',
  'My Address' => '私のアドレス',
  'No data found' => '何もデータがつかりませんでした',
  'My Order List' => '私の注リスト',
  'updated_successfully' => 'Updated successfully',
  'No conversetion found' => '会話が見つかりませんた',
  'shipping_method_update' => 'Shipping method update',
  'Admin | Login' => 'Admin | Login',
  'Software version' => 'フトウェアバージョン',
  'Search orders' => '注の索',
  'Search Product Name' => '製品名を検索',
  'Featured status updated successfully' => 'Featured status updated successfully',
  'New Product' => '新製品',
  'EX' => '',
  'After uploading products you need to edit them and set product images and choices' => '品をアップロードした、商品を集し、商品画像と選択を設定す必要があります',
  'No data to show' => '示するデータがありまん',
  'Product in wishlist report' => 'ィッシュリスト内の製レポート',
  'In-House' => '社内',
  'Filter' => 'Filter',
  'Asc/Dsc' => 'Asc/Dsc',
  'Total in Wishlist' => 'ィッシュリストの合計',
  'Discount_on_Purchase' => '入の割引',
  'start date' => 'Start date',
  'expire date' => 'Expire date',
  10 => '10',
  'minimum purchase' => 'Minimum purchase',
  'maximum discount' => 'Maximum discount',
  'Search by Title or Code or Discount Type' => 'タイトル、コーまたは割引タイプで検',
  'New notification' => 'New notification',
  'Choose file' => 'Choose file',
  'Search by Title' => 'タイトルから探',
  'Are you sure delete this' => 'これを削除してもろしいですか',
  'You will not be able to revert this' => 'You will not be able to revert this',
  'Yes delete it' => 'い、削除します',
  'notification deleted successfully' => 'Notification deleted successfully',
  'Add new' => 'Add new',
  'Add Product' => '製品の加',
  'Deal of the day form' => '今日の取引フォーム',
  'Product stock report' => '製品在レポート',
  'ASE/DESC' => 'ASE/DESC',
  'Total Stock' => '総在庫数',
  'Search by Product or Customer' => '製品まは顧客から探',
  'Search by Name or Phone or Email' => '前、電話番、メールアドレスで検索',
  'Search by Name or Email or Phone' => 'Search by Name or Email or Phone',
  'Search_by_Name_or_Mobile_No_or_Email' => '前またはモバイル番号または電子メルで検',
  'Are_you_sure_delete_this' => 'これを削除してよろしいですか',
  'Contact_deleted_successfully' => '連絡先 削除 成功しました',
  'Search by Subject' => '件名で検索',
  'Default Sales Commission' => 'デフォルの販手数料',
  'Seller Registration' => '販売者登録',
  'Seller Registration on/off' => '売者登録のオン/オ',
  'Turn on' => 'Turn on',
  'Turn off' => '消す',
  'Copy URI' => 'Copy URI',
  'Copied to the clipboard' => 'Copied to the clipboard',
  'EX of SMS provider s template : your OTP is XXXX here please check' => 'SMS プロバイダーのテンプレの EX : あなたの OTP は XXXX です。ここで確認しださい',
  'NB : XXXX will be replace with otp' => '注: XXXX は otp に置き換えられます',
  'NB : Keep an OTP variable in your SMS providers OTP Template' => '注意: SMS プロバイダーの OTP テンプレートに OTP 変数を保持してください。',
  'Shipping Method' => '配送方法',
  '4 to 6 days' => '4～6日',
  'Are you sure to delete this' => 'れを削除してもよろしいですか',
  'Credentials SetUp' => '認証情報のットップ',
  'Google API Set up Instructions' => 'Google APIのットアップ手順',
  'Go to the Credentials page' => '認情報ページに移動します',
  'Click' => 'クリック',
  'Select the' => '選択',
  'type' => 'Type',
  'Name your OAuth 2.0 client' => 'OAuth 2.0 クライアント名前を付ます',
  ...
  'Close' => '近い',
  'Facebook API Set up Instructions' => 'Facebook APIのセットップ手順',
  'Log in into your Facebook account (if you’re not)' => 'Facebook アカウトにログンします (ロインしいない場合)',
  'Go to the facebook developer page and' => 'Facebook の開発者ペーにアクセスし、',
  'Go to' => 'に行く',
  'from Navbar' => 'From Navbar',
  'From Register tab press' => '「登録タブから を押します',
  'From Verify Account tab' => '「アカウントの確認」ブから',
  ...
  'and press' => 'And press',
  'From Contact Info tab provide' => '「連絡先情報」タブか提供します',
  'check in' => 'Check in',
  'From About You tab press' => '「About Youタブを押すと',
  'Select an app type' => 'アプリの種類選択してください',
  'Complete the' => '完了',
  ...
  'Fill the form and press' => 'フォームに記入し押しください',
  'toggle button from the top' => 'Toggle button from the top',
  'Now copy' => '今すぐコピーしてくだい',
  'Twitter API Set up Instructions' => 'Twitter APIの定手順',
  'Instruction will be available very soon' => '説明書はすぐに入可能にります',
  'Add New Currency' => 'Add New Currency',
  'Enter currency Name' => '通貨名入力してください',
  'Enter currency symbol' => '通貨記号を入力しください',
  'Enter currency code' => '通貨コードを力してくだい',
  'Enter currency exchange rate' => '替レートを入してください',
  'Search Currency Name or Currency Code' => '通貨名または通貨コドの索',
  'Default' => 'フォルト',
  'All input field is required' => 'すべての入力ィールドは必須で',
  'Left' => 'Left',
  'Right' => '右',
  'Admin Shop Banner' => '管理者ショップのナー',
  '6:1' => '6:1',
  'Are you sure' => '本気ですか',
  'Be careful before you turn on/off maintenance mode' => 'ンテナンスモードをオ/フする前に注意してださい',
  'Both Phone & Email verification can not be active at a time' => '電話認証と子メール認証の両方を時にアクティブにすこはできません',
  'Add Help Topic' => 'ヘルプトックを追加',
  'Type Question' => '質問を入力してださい',
  'Type Answer' => '答えを入力してください',
  'Edit Modal Help Topic' => 'モール ヘルプ トックの編',
  'Are you sure delete this FAQ' => 'この FAQ を削除てもよろしですか',
  'FAQ deleted successfully' => 'よくある質問は正常に削されまし',
  'Social Media' => 'ソーャルメディア',
  'Instagram' => 'インスタラム',
  'Facebook' => 'Facebook',
  'Twitter' => 'ツイッー',
  'LinkedIn' => 'リントイ',
  'Pinterest' => 'ピンタレスト',
  'Google plus' => 'グーグルプラス',
  'Enter Social Media Link' => 'ーャルメディアリンク力してください',
  'Social Name Is Requeired' => 'ソャルネームは必須で',
  'Social Link Is Requeired' => 'ソーシャルリンク必要す',
  'Social Media Already taken' => 'ソーシャメディ すでに撮影み',
  'Social Media inserted Successfully' => 'ソーシャメディアが常に挿入れました',
  'Social info updated Successfully' => 'ソーシャル情報が正常に更されました',
  'Are you sure delete this social media' => 'このソーシャルディを削除してもよろいですか',
  'Social media deleted Successfully' => 'ソシルメディアが正常に除されました',
  'Invalid date range' => '無効な日囲です',
  'Show data by date range' => 'Show data by date range',
  'InHouse product sale report' => '社内製品販売ポート',
  'Total Sale' => '総上高',
  'Seller product sale report' => 'Seller product sale report',
  'My Shopping Cart' => 'My Shopping Cart',
  'Something went wrong!' => '何か題発生しました!',
  'Please fill all required fields' => '須フィールドをべて入力してください',
  'Choose Payment Method' => '支払い法を選択してださい',
  'Page Not found' => 'ページが見つかりまん',
  'We are sorry the page you requested could not be found' => 'ご要望のページがつかりませでした。',
  'Please go back to the homepage' => 'ホームページにってください',
  'HOME' => 'HOME',
  'Currency changed to' => '通貨が次のように更されました',
  'Item has been removed from cart' => '品がカートから削されました',
  'Sorry the minimum value was reached' => '訳ありませんが、最小に達しました',
  'Sorry stock limit exceeded' => '申しありませんが在庫制をえました',
  'Shop Page' => 'ショップページ',
  'Search Product' => '製品を検',
  'send successfully' => 'Send successfully',
  'Close sidebar' => 'サイドバーをじる',
  'product added successfully' => 'Product added successfully',
  'Are you sure Change this' => 'これを変更しもよろいですか',
  'Yes Change it' => 'はい、変します',
  'Order is already delivered You can not change it' => '注文すでに配達れていますで変更すことはできません',
  'Login' => 'ログイン',
  'Please ReType Password' => 'パスードを再入力してください',
  'Passwords do not match' => 'パスワードが一致していません',
  'password Must Be 6 Character' => 'Password Must Be 6 Character',
  'Passwords match' => 'パスワードが一致する',
  'Ready to Leave' => '出発準備了',
  ...
  'Logout' => 'ロアウト',
  'Update option is disabled for demo' => 'モは更新オプションがになっています',
  'Order List' => 'オーダーリス',
  'Brand Add' => 'ブランドの追加',
  'Brand List' => 'ランド一覧',
  'Product Bulk Import' => '製品の一イポート',
  'Coupon Add' => 'クーポンの追加',
  'Add new notification' => '新い通を追加',
  'Flash Deal' => 'フラッシュディル',
  'Deal Page' => '取引ページ',
  'Feature Deal' => '特集セル',
  'Product stock Report' => 'Product stock Report',
  'Product in Wishlist Report' => 'ィッシュリス内の製品ポート',
  'Seller List' => '販売者リスト',
  'Customer List' => '顧リスト',
  'Contact List' => '連絡先リスト',
  'Support Ticket' => 'サポートチット',
  'Seller Information' => '販売者情報',
  'Image uploaded successfully' => 'Image uploaded successfully',
  'Error Something went wrong' => 'エー 何か問題が発生しした',
  'Choose Image' => '像の選択',
  'This is not an image file' => 'This is not an image file',
  'Payment Method' => 'Payment Method',
  'SMS Module Setup' => 'SMSモジュのセットアップ',
  'Social Login' => 'ソーシャルグイン',
  'Web Config' => 'ウブ設定',
  'Mail Config' => 'メール設定',
  'FCM Settings' => 'FCM設定',
  ...
  'Seller product sale Report' => '出品者商品売レポート',
  'Create Role' => 'ロールの作',
  'Employee Add' => '従業の追加',
  'Employee List' => '従業員一覧',
  'Do you want to logout' => 'ログアウトします?',
  'Sign out' => 'サインアウト',
  'Copyright' => '作権',
  'Search by Product Name' => 'Search by Product Name',
  'New Request' => '新しいクエスト',
  'Want to delete this item' => 'の項目を除したい',
  'Chatting Page' => 'チャッページ',
  'Send a message' => 'メッセーを送ります',
  'No Message available' => '利用可能なッセーがありません',
  'Bank Info View' => 'Bank Info View',
  'Shop view' => 'ショップビー',
  'no_items_in_basket' => 'No items in basket',
  'Flash Deal Products' => 'フッシュディール商品',
  'Are you sure you want to Delete' => '消去してもよろしでか',
  'Address Update Successfully' => 'アドレスの新が成功しました',
  'All input field required' => 'すべの入力フィールドは須です',
  'Language Translate' => '言語翻訳',
  'Key removed successfully' => 'キー正常に削除されました',
  'Search by orders id or transaction id' => 'Search by orders id or transaction id',
  'Expand cart' => 'カートを展開る',
  'Checkout' => 'チェクアウト',
  'Coupon code' => 'クーポンコード',
  'Credit / Debit card ( Stripe )' => 'クレジット / デビッ カード (ストライプ)',
  'Error' => 'エラー',
  'No Product Found' => 'No Product Found',
  'All Seller Page' => 'べての販売者ページ',
  'Shop name' => 'Shop name',
  'All_Sellers' => 'すべての販者',
  'all' => '全て',
  'View_more' => 'もっと見る',
  'Flash Deal Update' => 'フッュディールアップート',
  'Update Deal' => '引を更新する',
  'Feature Deal Update' => 'Feature Deal Update',
  'Deal Update' => '取引の最情報',
  'Deal of the Day' => 'Deal of the Day',
  'Deal Product' => '取引商品',
  'Order is already delivered and transaction amount has been disbursed changing status can be the reason of miscalculation' => '注文すでに配達さており、取引金額は支払われてますが、スータスが変すると計ミスの原因となる可能性があります',
  'Think before you proceed' => '先に進前に考えてください',
  'GST' => '消費税',
  'comment' => 'Comment',
  ...
  'Product ID is required!' => 'ロダクトIDは必須で',
  ...
  'Your order ID' => 'あなたの注文ID',
  'If you need help or you have any other questions feel free to email us' => 'サポートが必要な、またはその他ご質がる場合はお気軽にメールでお問い合わせださ',
  'successfully added!' => 'Successfully added!',
  'order_placed_successfully' => 'Order placed successfully',
  'Invalid credential or account no verified yet' => '無効な資情報まはアカウントがまだ検証されていまん',
  'Copied successfully' => '正常にコピーされまた',
  'Product Edit' => '製編集',
  'successfully product updated!' => 'Successfully product updated!',
  'We are sorry server is not responding' => 'し訳ありませんサーバーが応答していませ',
  'Try after sometime' => 'ばらくしてから試しください',
  'Product Add' => '製品の追加',
  'Your existing session token does not authorize you any more' => '既セッション トークンはもう認証されません',
  'Seller Apply' => '販売者がし込む',
  'Customer_not_found_or_Account_has_been_suspended' => '顧客が見つからな、またはアカウンが停止されています',
  'Shop Edit' => 'ショップ編集',
  'Add Shipping' => '送を追加',
  'No conversation found' => '会話が見つかりませんした',
  'out_of_stock' => 'Out of stock',
  'Profile Settings' => 'プロファル設定',
  'Nav menu' => 'ビメニュー',
  'Basic' => '基本',
  'Full' => 'Full',
  'Your first name' => 'あなた下の名前',
  'Optional' => 'オプション',
  'Enter new email address' => '新しいメールアドレス入力しください',
  'Save changes' => '変更内容を存',
  'Change' => '変化',
  'your' => 'Your',
  'Enter new password' => '新しいパスワードを力してください',
  'Confirm' => '確認する',
  'Confirm your new password' => 'Confirm your new password',
  'changes' => 'Changes',
  'Register' => '登録する',
  'Please enter your first name' => 'あなた名を入力してくだい',
  'Please enter your last name' => 'あなたの姓を入力',
  'Please enter valid email address' => '有効なメーアドレスを入力してくい',
  'Please enter your phone number' => '電話番号を力してください',
  'Customer Details' => 'お客様情',
  'Customers' => 'お客様',
  'Customer details' => 'Customer details',
  'Customer ID' => '顧客ID',
  'Joined At' => '加しました',
  'Order ID' => '注文ID',
  'First name is required!' => '名前は必で!',
  'Last name is required!' => '姓は必須です!',
  'not_found' => 'Not found',
  'Update Currency' => '通貨の新',
  'Currency Name' => '貨名',
  ...
  'You order has been confirmed and will be shipped according to the method you selected!' => 'ご注は確認され、択され方法に従って発送されます。',
  'Track Order' => '注文を追跡する',
  ...
  '1 star' => '1 star',
  'Invoice' => '請求書',
  'Cart key or ID is required!' => 'カートキーまたはIDが必要です。',
  'Delivery status updated to' => 'Delivery status updated to',
  'order is already delivered' => 'Order is already delivered',
  'Invalid withdraw request' => '無効な出金クエトです',
  'follow_steps' => 'Follow steps',
  'Fill in your email address below' => '以にメールアドレスをしてください',
  'We will send email you a temporary code' => '一時的なコードをメールで送信します',
  'Use the code to change your password on our secure website' => 'コードを使用して安な Web サイトでパワーを変更してくだい',
  'Enter your email address' => 'メールアドレス入力してださい',
  'Please provide valid email address' => '有効メールアドスを入力しください',
  'Get new password' => '新いパスワード取得する',
  'login_first' => 'Login first',
  'Support Tickets' => 'Support Tickets',
  'Leave a Message' => 'Leave a Message',
  'Please write the message' => 'Please write the message',
  'Submit Reply' => '返信送信',
  'Shipping Method Update' => '送方法の更新',
  'Product added successfully!' => '商品が正常に追加されまし。',
  'Edit Shipping' => '配送の編集',
  'empty_cart' => 'Empty cart',
  'Incomplete bank info' => '不完全な銀行報',
  'Product name is required!' => '商品名は必須で！',
  'category is required!' => 'Category  is required!',
  'Product images is required!' => '商品画像は必須です！',
  'Product thumbnail is required!' => '商品のサムネイ必須です。',
  'brand is required!' => 'Brand  is required!',
  'Unit is required!' => '位は必須です！',
  'successfully product added!' => 'Successfully product added!',
  'Withdraw information View' => '出金情報を見る',
  'Note' => '注記',
  'Withdraw request process' => '出金リクエトプロセス',
  'Deny' => '拒否',
  'Note about transaction or request' => 'お取引やご頼に関するご注',
  'Brand Edit' => 'ブランド編集',
  'successfully removed!' => 'Successfully removed!',
  'Info updated successfully!' => 'Info updated successfully!',
  'Change status to paid' => 'ステースを有料に変する',
  'successfully review submitted!' => 'Successfully review submitted!',
  'Maintenance Mode on' => 'メンテナンスモードオ',
  'Website is under Maintenance' => 'ウェブサイトはンテナンスです',
  'Plese come back later' => 'またで来てください',
  'no_order_found' => 'No order found',
  'Discount can not be more or equal to the price!' => '価格上の割引できません。',
  'sent' => 'Sent',
  'successfully_canceled' => 'Successfully canceled',
  'Order Table' => 'Order Table',
  'No such data found!' => 'のようなデータは見つりませんでした',
  'Already in your wishlist' => 'でにウィッシュリスト入っています',
  'Password Reset' => 'パスワードリセット',
  'Reset Your password' => 'あなたのパスードをリセット',
  'Click to Reset' => 'Click to Reset',
  'First' => '初め',
  'Shop info updated successfully!' => 'ョップ情報が無事更新れました！',
  'product_list' => 'Product list',
  'Withdraw request sent successfully!' => '出金リクエストが正に送信されました。',
  'Edit Role' => '役割の編',
  ...
  'bkash' => 'Bkash',
  'username' => 'Username',
  'Contact View' => 'コンタトビュー',
  'View_User_Message' => 'ビュー ユーー ッセージ',
  'Not_Seen_Yet' => 'まだ見ていな',
  'User' => 'ユーザー',
  'Reply_from_admin' => 'Reply from admin',
  'No_reply' => '答なし',
  'Feedback' => 'ィードバッ',
  'Please_send_a_Feedback' => 'フィーバックを送信てくだい',
  'Seen' => 'た',
  'Send_Mail' => 'Send Mail',
  ...
  'delete' => 'Delete',
  'Update delivery-man' => '配達員を新る',
  'images' => 'Images',
  'Invalid credential or account suspended' => '無効な資報またはアカウントが停止されました',
  ...
  'label' => 'Label',
  '(Ex: Test Label)' => '（例：テストラベ',
  'reCAPTCHA Type' => 'ReCAPTCHA Type',
  'Sub type: I m not a robot Checkbox' => 'サタプ: 私はロボットはあませんチェックックス',
  'domain' => 'Domain',
  'Accept the reCAPTCHA Terms of Service' => 'reCAPTCHA 利用規約に同意する',
  'Press' => 'Press',
  'Enter recaptcha value' => '再キャプチャを入力しください',
  'Please check the recaptcha' => 'リキャプャを確認してください',
  'Go to the facebook developer page' => 'Go to the facebook developer page',
  'Click Here' => 'ここをクック',
  'If needed' => '必要に応じて',
  'Provide Primary Email and press' => 'プライマリ電子メールを入して押します',
  'In about section select' => '「概要セクションで選します',
  'Select an app type and press' => 'Select an app type and press',
  'Complete the add details form and press' => '詳細追加フォームに必要事を記入し、 を押しす',
  'left sidebar' => 'Left sidebar',
  'Make sure to check' => '必ずご確認くださ',
  'must on' => 'Must on',
  'Update Phone' => 'Update Phone',
  'few_steps_ahead' => 'Few steps ahead',
  'Verify' => '確する',
  'ReCAPTCHA Failed' => 'ReCAPTCHAが失敗しまし',
  'recaptcha' => 'Recaptcha',
  'gallery' => 'Gallery',
  'download' => 'Download',
  'upload' => 'Upload',
  ...
  'Please fill all required fields of shipping address' => '配送先所の必須フィールドをすて入力してください',
  'Please fill all444 required fields' => '444 個の必須フールドすべてに入力しください',
  ...
  'latitude' => 'Latitude',
  'longitude' => 'Longitude',
  'Please fill all required fields of shipping/billing address' => '配送先/請求先の必須フィールドをすて入力してくださ',
  'shipping_to' => 'Shipping to',
  'billing_to' => 'Billing to',
  'Billing_address' => '求先住所',
  ...
  'Product_quantity_updated!' => '製品数量が更新れました!',
  'Coupon Edit' => 'クーポ編集',
  ...
  'Redirecting_to_the_payment_page' => '支払いージへのリダイレク',
  ...
  'You_want_to_remove_all_items_from_cart!!' => 'カートからすべのアイテムを削除したす!!',
  'pos_order' => 'Pos order',
  'Print Invoice' => '求書を印刷する',
  'POS_order' => 'POS order',
  'extra_on_discount' => 'Extra on discount',
  'Forgot Password' => 'スワードをお忘れですか',
  'Forgot your password' => 'Forgot your password',
  'Change your password in three easy steps. This helps to keep your new password secure' => '3 つの簡なステップでパスード変更します。',
  'We will email you a temporary code' => '一時的なコードメールでお送りします',
  'clean_database' => 'Clean database',
  'environment_setup' => 'Environment setup',
  'You have new order Check Please' => '新しい文がありますでチェックしてください',
  'Ok let me check' => 'あ、私はチックしてましょう',
  'smtp_mail' => 'Smtp mail',
  ...
  'This_page_is_having_sensitive_data.Make_sure_before_changing.' => 'このペジには密データが含まていす。変更する前に必ず確認してください',
  'APP_NAME' => 'APP NAME',
  'APP_DEBUG' => 'APP DEBUG',
  'True' => '真実',
  'False' => 'False',
  ...
  'Clear' => 'クリア',
  'Sensitive_data! Make_sure_before_changing.' => '機密データ!',
  'Cancelled' => 'キャンセル',
  ...
  'Search by orders id or order_details_id' => 'オーダー ID は order details id で検索します',
  'refund_transaction_table' => 'Refund transaction table',
  'Update Notification' => 'アップデート通知',
  'Notification Update' => '知せの更新',
  ...
  'Refund Details' => '払い戻し詳細',
  'Refund request' => '払いしのリクエスト',
  ...
  'total_tax' => 'Total tax',
  'Seller POS' => '販売者POS',
  'Seller POS permission on/off' => '販売者 POS 許可のオン/フ',
  'approved_note' => 'Approved note',
  'rejected_note' => 'Rejected note',
  'digitaly_paid' => 'Digitaly paid',
  'payment_info' => 'Payment info',
  'Email Verification' => 'メー認証',
  'Verify your email' => 'あなた電子メール確認します',
  'Token' => 'トークン',
  ...
  'Search_by_order_id' => 'order id で検',
  ...
  'Becareful for change the mode' => 'モード変更は注意してください',
  'Becareful before change the mode' => 'ードを変更するに注してください',
  'For single vendor operation' => '単ベンダー運用の場合',
  ...
  'turn on' => 'Turn on',
  'turn off' => 'Turn off',
  'For single vendor operation please deactive all seller product' => '単一ベンダーの作の場合は、すべてのー製品を無効にしてくさい',
  'Search by orders id' => '注文IDで検索',
  'refund_id' => 'Refund id',
  'Search_by_order_id_or_refund_id' => 'order id or refund id で索',
  ...
  'For multi vendor operation' => 'マルチンダ運用向け',
  'For single vendor operation deactive all seller!!' => '単一ベンダーの作のため、すてのセラーを無効にしす。',
  'Now your multi vendor business mode is opening you can add new seller !!' => 'マチベンダー ジネス ードが開き、しい販売者を追加できようなりました。',
  'order_canceled_successfully' => 'Order canceled successfully',
  'Multi-currency is depends on exchange rate and your gateway configuration So if you don t need multi-currency it will be better select single currency. (We prefer to use single currency).' => '複通貨は為替レートゲートウェイ構成によ異なります。そのため複数通貨が必要ない場は、単一通貨を選択るとをお勧めします',
  ...
  'The billing period for your paid subscription to Google Workspace begins tomorrow.' => 'Google Workspace の有料サスクリプションの請求期間は日から始まりす。',
  'Items Ordered' => '注文した品',
  'thank_you_for_order' => 'Thank you for order',
  'Go to your order' => '注文に進ます',
  ...
  'Order Wise Shipping Method deleted successfully' => 'オーダーワイズ配送方法が常に削除れました',
  ...
  'Update & Publish' => '更と公開',
  'admin_approval_for_products_updated_successfully!' => '製品の管理者の承認が正常に更新さまた!',
  'of' => 'Of',
  ...
  'Notification mail for new order received' => '新規注文通知メ受信',
  'We have sent you this email to notify that you have a new order. You will be able to see your orders after login to your panel' => '新しい注あることを通知するめこのメールを送信しました。',
  'New order ID for you' => '新しい注文ID',
  ...
  'Main Banner' => 'メインバナー',
  'Footer Banner' => 'ッターバナー',
  'Popup Banner' => 'ポップアプバー',
  'Are_you_sure_remove_this_product' => 'この品を削してよろしいですか',
  'product_removed_successfully' => 'Product removed successfully',
  'Removed' => '削除されました',
  'Create credentials' => '認証情報作成',
  'OAuth client ID' => 'OAuthクラアントID',
  'Web application' => 'ウェブアプリケーション',
  'ADD URI' => 'ADD URI',
  'Authorized redirect URIs' => '承認さたリダイレト URI',
  'Callback URI' => 'コールバク URI',
  'Create' => 'Create',
  'Client ID' => 'クライントID',
  'Client Secret' => 'クライアントシークット',
  'Get Started' => 'めましょう',
  'Continue' => '続く',
  ...
  'Create App' => 'アプリ成',
  'Facebook Login' => 'イスブックログイン',
  'Set Up' => 'Set Up',
  'Site URL' => 'サイトのURL',
  'Base URL of the site ex:' => 'Base URL of the site ex:',
  'Client OAuth Login' => 'Client OAuth Login',
  'Valid OAuth Redirect URIs' => '有効な OAuth リイクト URI',
  'Save Changes' => '変更内容を保存',
  'Currency status successfully changed.' => '通貨ステースが常に変更されました。',
  ...
  'Currency removed successfully!' => '通貨が常に削除されました。',
  'Currency updated successfully!' => '通が正常に更されました。',
  '250x60 px' => '250x60 px ',
  ...
  'min' => 'Min',
  'sec' => 'Sec',
  'Main Section Banner' => 'メイセクションバナー',
  'Fast Delivery all accross the country' => '全へ短納期でお届けしま',
  ...
  'Your Email Address' => 'あなたのメールアレス',
  'subscribe' => 'Subscribe',
  'Head Office' => '本社',
  'Your subscription successfully done!!' => 'Your subscription successfully done!!',
  'You already subcribed this site!!' => 'あなたはすでこサイトを購読していま!!',
  'subscriber_list' => 'Subscriber list',
  'System Default currency updated successfully!' => 'システムのデフォト通貨が正常に更新さました。',
  'Search Products' => '製品を探す',
  'wish_listed' => 'Wish listed',
  'Seller_info' => '販売者情',
  'chat' => 'Chat',
  'Visit Store' => 'ストアにアクス',
  'More From The Store' => 'スアからの詳細',
  'ratings' => 'Ratings',
  'Excellent' => '素晴らしい',
  'Good' => '良い',
  'Average' => 'Average',
  'Below Average' => '平均以下の',
  'Poor' => '貧し',
  'Product Review' => '製レビュー',
  'You_can_track_your_order_by_clicking_the_below_button' => '下のボタンクリックするこで注文追跡できます',
  'overview' => 'Overview',
  'Chat with seller' => '販売者とチャトする',
  'Search products from this store' => 'このスアから商品をす',
  ...
  'Search_by_email' => 'メール検索',
  'Ratio_1:1' => '比 1:1',
  'Start a conversation' => '会話を始める',
  'Your_shop_address' => 'あなたショップの所',
  'SUPPORT TICKET ANSWER' => 'サポートチケットの回答',
  'Date Submitted' => '提出日',
  'Last Updated' => '最終更新',
  'Submit message' => 'メッセジを送信る',
  ...
  'Before delivered you need to make payment status paid!' => '配達前に支払ステースを支払い済にする必要があります。',
  'view_website' => 'View website',
  'Order_list' => 'オーーリト',
  'refund_management' => 'Refund management',
  'POS_Orders' => 'POS 注文',
  'export' => 'Export',
  'Business_Setup' => 'ビジネス セットアップ',
  'System Settings' => 'ステム設定',
  '3rd_party' => 'サードパーティ',
  ...
  'Sorry the minimum order quantity does not match' => '申し訳ありませんが、最低注文が一致しません',
  ...
  'Refund_Requests' => 'リクエスト',
  'Category_Setup' => 'カテゴリ セットアップ',
  'Categories' => 'テゴリー',
  'Sub_Categories' => 'サブカテゴリ',
  'Sub_Sub_Categories' => 'ササカテゴリ',
  'Product_Attributes' => '製品の属性',
  'promotion_management' => 'Promotion management',
  'Offers_&_Deals' => 'オファー & ディール',
  'Flash_Deals' => 'フラッシュセール',
  'Featured_Deal' => '注目のセール',
  ...
  'Reports' => 'レポート',
  'Analysis' => 'Analysis',
  'Sales_&_Transaction_Report' => '売 & 取引 レポート',
  'Statistics' => '統計',
  'Order_Transactions' => 'Order Transactions',
  'Refund_Transactions' => '返金 トランザクョン',
  'Product_Report' => '製品 ポート',
  'Wishlisted_Products' => 'ウィッシリスト登録された製品',
  'user_management' => 'User management',
  'Customer_List' => 'Customer List',
  'wallet' => 'Wallet',
  'Loyalty_Points' => 'Loyalty Points',
  'Add_New_Seller' => '新しい販売者追加',
  'Seller_List' => '売者リスト',
  'subscribers' => 'Subscribers',
  'Employee_Role_Setup' => '従業員の割の設定',
  'Employees' => '従業員',
  'System_Settings' => 'システム設定',
  'Pages_&_Media' => 'ペジ & メディア',
  'pages' => 'Pages',
  'Social_Media_Links' => 'ソーシャルメディアリン',
  'System_Setup' => 'System Setup',
  'Business Setup' => '業の設立',
  'Profile' => 'プロフィール',
  'shop_banner' => 'Shop banner',
  'shop_logo' => 'Shop logo',
  'Search Ticket by Subject or status...' => '件名またはステタでチケットを検索...',
  'packaging' => 'Packaging',
  'Out_For_Delivery' => '配達',
  'Failed_To_Delivery' => '信に失敗しました',
  'Seller_Wallet' => '販売者ウレット',
  'Pending_Withdraw' => '保留中 引き出し',
  ...
  'OK' => 'わかりました',
  'Product_Section' => '製品 クション',
  'Search by Name' => '名前で検索',
  'Billing_Section' => '請求 セクョン',
  'Paid By' => 'によって支われました',
  'Card' => 'カード',
  'Cancel_order' => '注文をキャンルする',
  'place_Order' => 'Place Order',
  'apply' => 'Apply',
  'Product already added in cart' => 'でにカートに商品が追されていま',
  'Sorry product out of stock' => '申し訳ございませが在庫切れ商品です',
  'Item has been added in your cart!' => '商品がカート追加されまし。',
  'Please choose all the options' => 'すべてのオプョン選択してください',
  'range' => 'Range',
  'show' => 'Show',
  ...
  'barcode' => 'Barcode',
  'Add_new_product' => '新し製品の追加',
  'product_type' => 'Product type',
  'physical' => 'Physical',
  'digital' => 'Digital',
  'digital_product_type' => 'Digital product type',
  'Ready After Sell' => '後の準備完了',
  'Ready Product' => '既製品',
  ...
  'Send_Reply' => '信 返信',
  'bulk_Import' => 'Bulk Import',
  'You can upload your product images in product folder from gallery and copy image`s path' => 'ギャラリーら製品フォルダーに品像をアップロード、画像のパスをコピーできす',
  'Bank Information' => '銀行情報',
  'Holder_Name' => 'ホルダーネーム',
  'Bank_Name' => '銀行名',
  'Branch_Name' => '支店名',
  'Account_Number' => '口座号',
  'Edit_Bank_info' => '行情報の集',
  'Edit_Bank_Info' => '行情報の編',
  'Shop_Info' => 'ショップ情報',
  'add_new_deliveryman' => 'Add new deliveryman',
  'Ex : 017********' => 'Ex : 017********',
  'Ex : ex@example.com' => '例: ex@example.com',
  'Ex : password' => '例：パスード',
  'Profile_Image' => 'プロフィール 像',
  ...
  'Privacy_Policy' => 'プラバシポリシー',
  'About_Us' => '私たちについて',
  'withdraw' => 'Withdraw',
  'action_disabled' => 'Action disabled',
  'Order_Report' => '注文 レート',
  'Total orders of' => '合計注文数',
  ...
  'Select Coupon Type' => 'ーポンの種類を選択してください',
  ...
  'Failed_to_Deliver' => '配信に失敗しした',
  'sign_up' => 'Sign up',
  'Search here ...' => '検索 ...',
  'Expand Menu' => 'ニュー展開する',
  'chat_with_delivery-man' => 'Chat with delivery-man',
  'tax_fee' => 'Tax fee',
  'Write your message here...' => 'ここにメッセージを書いてくださ...',
  'sign_in_with_google' => 'Sign in with google',
  'sign_in_with_facebook' => 'Sign in with facebook',
  'Online Shopping' => 'オンインショッング',
  ...
  'Shop_Information' => 'ショプ情報',
  'Orders Served' => '注文の処理',
  'Account has been deleted you can not change the status!' => 'アカウトが削除されてるため、ステータスを変更ることはできませ。',
  'Chat' => 'チャット',
  ...
  'Failed To Deliver' => '配信に敗しました',
  'Refund_Request_List' => '返金リクエトリスト',
  'Help_&_Support_Section' => 'Help & Support Section',
  'Delivery-Man' => 'Delivery-Man',
  'My_Bank_Info' => '私の銀行情報',
  'My_Shop' => 'My Shop',
  'Support Ticket Answer' => 'サポートチッの回答',
  'Order No' => '文番号',
  'Coupon Discount' => 'クーポン割引',
  'My Order' => 'My Order',
  'Estimated Delivary Date' => 'お届け定日',
  'First step' => 'First step',
  'Order placed' => '注文済み',
  'Second step' => '第二段階',
  'Packaging order' => '梱包順序',
  'Third step' => 'Third step',
  'Preparing Shipment' => '発送準中',
  'Fourth step' => '第4テプ',
  'Order Shipped' => 'Order Shipped',
  'View Order Details' => 'View Order Details',
  'Image ratio should be 1:1' => '像の比率は 1:1 である要があります',
  'delete_account' => 'Delete account',
  'My Loyalty Point' => 'のロヤルティポイント',
  ...
  'Earning_Reports' => '収益 レポー',
  'Admin_Earning' => '管者 収益',
  'Seller_Earning' => '売り手 収益',
  'Total Sales' => '総売上',
  'Search by sores' => '傷から探す',
  'Seller Info' => '販売者報',
  'Earn From Order' => 'Earn From Order',
  'Earn From Shipping' => '配送で稼ぐ',
  'Discount Given' => '割引あ',
  'Tax Given' => '与えられた税金',
  'Total Earning' => '総収益',
  'Withdrawable Balance' => '引出し可能な残高',
  'Do_you_want_to_logout' => 'ログアウトしたいすか',
  'reports' => 'Reports',
  'Transaction_Report' => 'トランザクョン レポー',
  'Environment_Setup' => '境 セッアップ',
  'Generate_Site_Map' => 'サイトマプの生成',
  'Analytic_Script' => '析スクリプト',
  'Currency_Setup' => '通貨設定',
  'Languages' => '言語',
  'Clean_Database' => 'クリーデータベース',
  'Environment_Information' => '環境情',
  ...
  'Most_Popular_Stores' => '最も人気る店舗',
  'Top_Delivery_Man' => 'トップ 配達 男',
  'Key translated successfully' => 'キーは正常に変換されした',
  'translate' => 'Translate',
  'general_settings' => 'General settings',
  'App_Settings' => 'アプリ 設定',
  'refund' => 'Refund',
  'By_turning_on_maintaince_mode _all_your_app_and_customer_side_website_will_be_off._Only_admin_panel_and_seller_panel_will_be_functional' => 'メンテナンス モーをンにすることで、べてのアプリと顧客側のウブサイトがオフなりま。管理者パネと販売者パネルのみが機能しま',
  'Company_Information' => '企業情報',
  'company_address' => 'Company address',
  'business_Information' => 'Business Information',
  'Position' => '置',
  'Company_Copyright_Text' => '会社 著権 テキスト',
  'Website Color' => 'ウェサイトの',
  'Primary_Color' => '原',
  'Secondary Color' => '二色',
  'Website Header Logo' => 'ウェブサイトのッーのロゴ',
  'Website_Footer_Logo' => 'ウェブサイ フッター ロゴ',
  'Website Favicon' => 'ウェブサイトのファビコン',
  'Loading Gif' => 'GIFの読み込み',
  'App_Logo' => 'アプリ ',
  'Cancel_Order' => '注文をキャンセルする',
  'Place_Order' => '注文する',
  'Sorry product is out of stock.' => '申し訳ありませんが、商品は在庫切れです',
  'Earning_Report' => '収 レート',
  ...
  'No Account' => 'アカウンがあません',
  'Already_Withdrawn' => 'すでに退会み',
  'Add_New' => '新し追加する',
  'Search Data' => 'データ検索',
  'This Year' => '今',
  'This Month' => '今月',
  ...
  'Total In-House Products' => '自社製品計',
  'Earning Statistics' => '収益統計',
  'Payment Statistics' => '支い統計',
  'Payments Amount' => '支払金額',
  'Cash Payments' => '現金払い',
  'Digital Payments' => 'デジタ決済',
  'Wallet Payments' => 'ウォレットで支払い',
  'In-House Earning' => 'In-House Earning',
  'Commission Earning' => 'コミッョン収',
  'VAT/TAX' => '付加価税/税金',
  ...
  'Start_Date' => '開始日',
  'End_Date' => '終了日',
  'Search by Order ID' => '注文IDで検索',
  'Order_&_Shipping_Info' => '文 & 配送 情報',
  ...
  'Fill_all_required_fields_of_billing_address' => '請求先住所のすべての必フィールドを入力しださい',
  'Download' => 'ンロード',
  'Product_not_uploaded_yet' => '製品はだアップロードされてませ',
  'File' => 'フイル',
  'File type: jpg jpeg png gif zip pdf' => 'ファイタイプ: jpg jpeg png gif zip pdf',
  'Product Report' => '品レポート',
  'product_report' => 'Product report',
  'All_Products' => 'べての製品',
  'Out_of_Stock_Products' => '在庫切れの商品',
  'Wish_Listed_Products' => '欲しものリストにる製品',
  'Product Unit Price' => '品単価',
  'Total Amount Sold' => '総販売額',
  'Total Discount Given' => '与えられ割引総額',
  'Average Product Value' => '平均製品',
  'Current Stock Amount' => '現在の在庫量',
  'Average Ratings' => '平均評価',
  'Last Updated Stock' => '最終された在庫',
  'In-House_Product_List' => '自社製品覧',
  'Limited Sotcks' => '庫に限りがございま',
  'Add_New_Product' => '新い製品の追加',
  'Show_as_featured' => '特集として示',
  'Discount_Type' => '引タイプ',
  ...
  'In-Active' => 'In-Active',
  'No Data found' => '何もデーが見つかりせんでし',
  'Total Seller' => '総販売者',
  'Total Seller Products' => 'トータルラー製',
  'Rejected' => '否さました',
  'Pending Request' => 'Pending Request',
  'Active Product' => 'アクテブ製品',
  'Seller Wallet Status' => 'Seller Wallet Status',
  'Wallet Amount' => 'ウォレット金額',
  'Withdrawble Balance' => '引き出し可能な残高',
  'Pending Withdraws' => '保留中の引き出し',
  'Already Withdrawn' => 'すで回されています',
  'cash on delivery' => 'Cash on delivery',
  'admin_bearer' => '管理者ベアラー',
  'Failed_to_deliver' => '配信に失敗した',
  'Select_coupon_type' => 'クーポンの種類を選択してください',
  'Free_Delivery' => '無料配達',
  'First_Order' => '最初の注文',
  'coupon_bearer' => 'Coupon bearer',
  'Select_coupon_bearer' => 'クーポンベアラー選',
  'admin' => '管理',
  'select_seller' => 'Select seller',
  'Select_customer' => '顧客選択',
  ...
  'Admin_Earning_Report' => '管理者 収益 レポート',
  'In-House_earning' => 'In-House earning',
  'shipping_earn' => 'Shipping earn',
  'discount_given' => 'Discount given',
  'refund_given' => 'Refund given',
  'All_copy_right_reserved__2023_' => 'All copy right reserved © 2023 ',
  'Search_Data' => '検索 データ',
  'This_Week' => '週',
  'Custom_Date' => 'カタム日付',
  'Tax Collected' => '徴収される税金',
  'Seller_Info' => '販売者情',
  'Earn_From_Order' => '注から獲得',
  'Earn_From_Shipping' => '送料から稼ぐ',
  'Commission_Given' => 'コミッション ギブ',
  'Discount_Given' => 'Discount Given',
  'Tax_Collected' => '収税額',
  'Refund_Given' => 'Refund Given',
  'Total_Earning' => '合計 収益',
  ...
  'Seller_Order' => '売者 注文',
  'Total_In-House_Products' => '社内製品の合計',
  'Total_Stores' => '計店舗数',
  ...
  'In-House Products' => '自社製品',
  'Seller Products' => '販売者の製品',
  ...
  'Transaction Statistics' => 'トザクション統計',
  'Search by ID...' => 'IDで検索…',
  'XID' => 'XID',
  ...
  'Total_Expense' => '合計経費',
  'Free_Delivery_on_Coupon_Discount' => 'クーポン引にる送料無料',
  'Coupon_Discount' => 'Coupon Discount',
  ...
  'paypal' => 'Paypal',
  'Total Amount' => '合計額',
  'Product Discount' => '製品割',
  'Shipping Charge' => '送',
  'filter_data' => 'Filter data',
  'reund_requests' => 'Reund requests',
  'Pending_Refund_Requests' => '保中の返金クエスト',
  'product_info' => 'Product info',
  'total_amount' => 'Total amount',
  'filter Data' => 'Filter Data',
  'Filter_Data' => 'フィルターデータ',
  'Total_Earnings' => '合計収益',
  'all_sellers' => 'すべての売者',
  'active_sellers' => 'アクティブ販売者',
  ...
  'Push_Notification_Setup' => 'プッシュ通設',
  'Social_Media_Login' => 'ソーシャルメディアロイン',
  'NB_:_#OTP#_will_be_replace_with_otp' => '注意 : #OTP# will be replace with otp',
  'Google_Recapcha_Information' => 'Google Recapcha Information',
  'Credentials_SetUp_page' => '資格情報 SetUp ページ',
  'To get site key and secret keyGo to the Credentials page' => 'サイト キーと秘密キー取得するには、[資格] ページに移動しま。',
  'Click_here' => 'こをクリック',
  'Add_a _abel_(Ex:_abc_company)' => 'Add a  abel (例: abc company)',
  'Select_reCAPTCHA_v2_as_ReCAPTCHA_Type' => 'Select reCAPTCHA v2 as ReCAPTCHA Type',
  'select_sub_type' => 'Select sub type',
  'Check_in_“Accept_the_reCAPTCHA_Terms_of_Service”' => 'チェックインreCAPTCHA利用規約に同意する」',
  'Press_Submit' => 'プレス 送信',
  'Copy_Site_Key_and_Secret_Key _Paste_in_the_input_filed_below_and_Save.' => 'サイ キーとシーレット キをコピー、入力フィールドの下貼り付けて保します。',
  'ongoing' => 'Ongoing',
  'Total_Deliveryman' => '合計 配達員',
  'Total_Store_Earnings' => '店舗収益合計',
  'Product has been added to wishlist' => '製品がウィッシリストに追加さました',
  'app_settings' => 'App settings',
  'Total_Sales' => 'Total Sales',
  'Product_Name' => 'Product Name',
  'Product_Unit_Price' => 'Product Unit Price',
  'Total_Amount_Sold' => '販売合計金額',
  'Total_Discount_Given' => '合計 割引 付与',
  'Average_Product_Value' => '平均製品値',
  'Current_Stock_Amount' => 'Current Stock Amount',
  'Average_Ratings' => '均評価数',
  'total_product' => 'Total product',
  'Sales_Statistics' => '売上 統',
  'Average_Sales_Value' => '平売上高',
  'Total_Product_Sale' => '合計 製品 売上',
  'Total_Product' => '合計 品',
  'Seller_Product_List' => '販売者 製品 リスト',
  'Top_5_Product_Wise_Sale' => 'ップ 5 製品 ワイズ セル',
  'All_Priority' => 'All Priority',
  'All_Status' => 'べてのステータス',
  'Open' => '開ける',
  'low' => 'Low',
  'Website Problem' => 'ウェサイトの問題',
  'Info inquiry' => '情報お問合わせ',
  'Sub' => 'サブ',
  'Select_main_category' => 'メインテゴリの選択',
  'sub_sub_category_list' => 'Sub sub category list',
  'select_category' => 'Select category',
  'Total_Sale' => '合計売上高',
  'Search_by_Name' => 'Search by Name',
  'Brand_Logo' => 'ブランロゴ',
  'Download the format file and fill it with proper data.' => 'フォーット ファイルをダウンロードし適切なデーを入力しま。',
  'You can download the example file to understand how the data must be filled.' => 'サンプル フイルをダウンードすと、データをどのように入力する必要あるを理解できます。',
  'Once you have downloaded and filled the format file' => 'ォマットファイルをダロードして入力したら、',
  'upload it in the form below and submit.' => 'Upload it in the form below and submit.',
  'After uploading products you need to edit them and set product images and choices.' => '商アップロードした後商を編集し、商品画像と選択肢を設定する要がります。',
  'You can get brand and category id from their list' => 'リストかブランとカテゴリID取得できす',
  'please input the right ids.' => 'Please input the right ids.',
  'You can upload your product images in product folder from gallery' => 'ギャラリーから製品ォルダーに品画像をップロードでます',
  'and copy image`s path.' => 'And copy image`s path.',
  'Don`t_have_the_template_ ' => 'テンプレートを持っていな',
  'download_here' => 'Download here',
  'Deal Of The Day' => '今日の取引',
  'Select Product' => '製品の選',
  'Limited_Stocked_Products_List' => '限定在庫品リスト',
  'Purchese price' => '購入金',
  'Current_Stock' => '在の在庫',
  'In-Stock' => '在庫あり',
  'Out_of_Stock' => '在庫切れ',
  ...
  'No_data_to_found' => 'ータが見つかりませ',
  'Due_Amount' => '期限 額',
  'Already_Settled' => 'でに決済済み',
  'Total_Order_Amount' => '合計注文金',
  'Order_Statistics' => 'Order Statistics',
  'Payment_Statistics' => '支払い 統計',
  'Cash_Payments' => '現金 支い',
  'Digital_Payments' => 'デジタル支払い',
  'Products_Stock' => '製品 在庫',
  'Product_Stock' => '製品 庫',
  'Active_Products' => 'クィブな製品',
  'Inactive_Products' => 'Inactive Products',
  'Pending_Products' => '保留中 製品',
  'available' => 'Available',
  'Attribute_Setup' => '属性 設定',
  'Attribute_Name' => '属性名',
  'not_available' => 'Not available',
  'Completed_Orders' => '完 注文',
  'Ongoing_Orders' => 'Ongoing Orders',
  'Canceled_Orders' => 'Canceled Orders',
  'order_ID' => 'Order ID',
  'Expense_Transaction_Statement' => '経費引明細書',
  'stock_sort_by_(low_to_high)' => 'Stock sort by (low to high)',
  'stock_sort_by_(high_to_low)' => 'Stock sort by (high to low)',
  'software_update' => 'Software update',
  'admin wallets' => '理者ウレット',
  'admin wallet histori...' => '管理者のウォット履歴...',
  'attributes' => 'Attributes',
  ...
  'Withdrawal_method_List' => '出金方法覧',
  'Add_method' => 'メソッド',
  'Add_fields' => 'フィールドの追加',
  'method_name' => 'Method name',
  'Input Field Type' => '入力ィールドの種類',
  'String' => '弦',
  'field_name' => 'Field name',
  'placeholder_text' => 'Placeholder text',
  'This_field_required' => 'このフールドは必須です',
  'default_method' => 'Default method',
  'Reset' => 'リセット',
  'Reached maximum' => '最値達しました',
  'ok' => 'Ok',
  'Add_Fields' => 'フールドの追加',
  'methods' => 'Methods',
  'account_name' => 'カウント名',
  ...
  'Default_Method_updated_successfully' => 'デフォトメソッド更新成功',
  'Default_Method_updated_failed.' => 'デフォトメソッ更新失敗。',
  'Method_name' => 'メソッド名',
  'method_fields' => 'Method fields',
  'active_status' => 'アクテブステータス',
  'status_updated_failed.' => 'Status updated failed.',
  'rtgr' => 'Rtgr',
  'Withdraw_Request' => '引出し要求',
  'Select_Withdraw_Method' => '引き出方の選択',
  'Total_Shop' => 'Total Shop',
  'Cash_ Payments' => '現金 支払い',
  'Wallet_Payments' => 'ウォレッ 支払い',
  'shop_info' => 'Shop info',
  ...
  'Configure' => '構成、設定',
  'successfully_updated' => 'Successfully updated',
  'Store_Client_ID' => 'ス クライアント ID',
  'Store_Client_Secret_Key' => 'Store Client Secret Key',
  'See_Credential_Setup_Instructions' => 'Credential Setup 手順」参してください',
  'payment_by' => 'Payment by',
  'payment_note' => 'Payment note',
  'transaction_ID' => 'Transaction ID',
  'offline payment' => 'Offline payment',
  'Payment_Note' => 'お支払い メモ',
  'Payment_Details' => 'Payment Details',
  'Shop_Name' => 'ショプ名',
  'Shipping_Address' => 'おけ先の住所',
  'Billing_Address' => '請求先住所',
  'Contact_Number' => '連絡先番号',
  'Order_Invoice' => '注 請求書',
  'Total_Ordered_Product_Price' => 'Total Ordered Product Price',
  'Total_Product_Discount' => '合計 製品 引',
  'Total_Coupon_Discount' => '合計 クーポ 割引',
  'Total_Discounted_Amount' => '計割引金額',
  'Total_Delivery_Charge' => 'Total Delivery Charge',
  'totals' => 'Totals',
  'Admin_Discount' => '管理 割引',
  'Seller_Discount' => '販売者 割引',
  'Admin_Commission' => '管者 コミッション',
  'Admin_Net_Income' => '管理者純収入',
  'Seller_Net_Income' => '販売者の純収入',
  'Social_Media_Chatting' => 'ソーャル メディア チャッ',
  'Social-Media-Chatting' => 'ソーシャルメディアャット',
  'Social_Media_Chat' => 'ソーシャルディチャット',
  'messenger' => 'Messenger',
  'paste_script' => 'Paste script',
  'WhatsApp' => 'ワッツアップ',
  'whatsapp_phone_number' => 'Whatsapp phone number',
  'Refund_Policy' => '代金返却方針',
  'Return_Policy' => 'Return Policy',
  'Cancellation_Policy' => '取消し規約',
  ...
  'Shop_cover_Image' => 'ショップカバー像',
  'offline_payments' => 'Offline payments',
  'order_transactions' => 'Order transactions',
  'Search_by_Order_ID_or_Transaction_ID' => 'Order ID また Transaction ID で検索',
  'Total_Shop_Earnings' => '合計ップ収益',
  'Total_Product_Amount' => 'Total Product Amount',
  'Product_Discount' => '製品 割引',
  'Discounted_Amount' => '割引金額',
  'Delivery_Charge' => 'Delivery Charge',
  'Order_Amount' => '注文額',
  'seller shipping' => 'Seller shipping',
  'Weekly Delivery' => '毎週の配達',
  'Earning_From_Shipping' => '送料から収益',
  'Total_Tax' => '合計 税金',
  'Seller_Wallet_Status' => '販売者 ウレット ステータス',
  'Withdrawble_Balance' => '出金 残高',
  'Pending_Withdraws' => '保留 引き出し',
  'Offline_Payments' => 'オフラン 支払',
  'Shipping_Charge' => '送 料金',
  'Cash_Payment' => '現金払い',
  'Wallet' => '布',
  'expense_Statistics' => 'Expense Statistics',
  'Digital Product' => 'Digital Product',
  'Digital Product on/off' => 'デジタルプロダクトのン/オフ',
  'Product_Brand' => '製品 ブラド',
  'Product Brand on/off' => '製品ブンドのオン/オフ',
  'Order_Settings' => '注文 設定',
  'Show_Billing_Address_In_Checkout' => 'チェックアウトの請求先所を表示',
  ...
  'thanks' => 'Thanks',
  'i_Accept' => 'I Accept',
  'Your_Privacy_Matter' => 'あたのプライバーの問題',
  'total_transaction' => 'Total transaction',
  'Product_Statistics' => '製品 統計',
  'Total_Expense_Amount' => 'Total Expense Amount',
  'Free_Delivery_Amount' => '無料 配達 額',
  'Coupon_Discount_Amount' => 'クーポン 割引 金額',
  'Transaction_Date' => '取日',
  'Expense_Type' => 'Expense Type',
  'Expense_Amount' => '経費 金額',
  'Total_Products' => 'Total Products',
  'Soon_Stock_Out' => 'もうす庫切れになります',
  'Search_Method_Name' => '検索法名',
  'erfe' => 'Erfe',
  ...
  'Total_Quantity_Sold' => '販売総数量',
  'open' => 'Open',
  'Partner request' => 'Partner request',
  'Chat_with_deliveryman' => '配達員とャットする',
  'Deliveryman_Review' => 'Deliveryman Review',
  'pay_by_wallet' => 'Pay by wallet',
  'If_you_require_any_assistance_or_have_feedback_or_suggestions_about_our_site _you' => '何らかのサポートが要な場合、またはサイ関するフィードバッまたは提案がある場合  あなた',
  ...
  'customer_Info' => 'Customer Info',
  'Total_Amount' => 'Total Amount',
  'Available_Color' => '利用可な 色',
  'Temporary_Closed' => 'Temporary Closed',
  'This_shop_is_in_temporary_closed' => 'このショプは一時的閉店しています',
  'This_shop_is_in_vacation_mode' => 'このショッは休暇モド中です',
  ...
  'after_the_order_is_delivered_total_order_amount_will_be_shown_here' => '文配達後の合計注文金額がここに表示れま',
  'product_wise_discounted_amount_will_be_shown_here' => 'Product wise discounted amount will be shown here',
  'The_product_report_will_show_based_on_the_product_added_date' => '製品レポートは、製品の加に基づいて表示され',
  'free_delivery_coupon' => 'Free delivery coupon',
  ...
  'Flash_Deal' => 'フラッシュデル',
  'stores' => 'Stores',
  'All_Categories' => 'すべのテゴリ',
  'Find_What_You_Need' => '必要なもの探す',
  'Term_&_Conditions' => '期 & 条件',
  'Accounts' => 'カウント',
  'Quick_Links' => 'クイックリン',
  'Featured_Products' => 'すすめ商',
  'Hotline' => 'ホットイン',
  'Become a Delivery Man' => '配達員になる',
  'Open Your Store' => 'ストア開く',
  'Help & Support' => 'ヘルプサポト',
  'Top Stores' => 'トプストア',
  'New Arrivals' => '新着',
  ...
  'Message_Log' => 'ッセージログ',
  'Abc' => 'ABC',
  'already_check' => 'でにチェックしています',
  'Become_a_Delivery_Man' => 'Become a Delivery Man',
  'Open_Your_Store' => 'あなたのストを開く',
  'Help_&_Support' => 'ヘルプサポート',
  'Top_Stores' => 'トップ 舗',
  'New_Arrivals' => '新',
  'Free_Shipping' => 'Free Shipping',
  'Fresh_Product' => '新な製品',
  '100%_Secure_Payment' => '100% 安全 支払',
  'We_Ensure_Secure_Transactions' => 'We Ensure Secure Transactions',
  '24/7_Support_Center' => '24/7 サポート セン',
  'Privacy Policy' => 'プバシーポリシー',
  'Refund Policy' => '代金返却針',
  'Return Policy' => '品規則',
  'Cancellation Policy' => 'り消し規約',
  ...
  'Become_a' => 'なる',
  'Search_for_items_or_store' => 'アイムまたはストアの検索',
  'Discounted_Products' => '引済み 製',
  'Select_Category' => 'カゴリを選でください',
  'login_to_your_account' => 'Login to your account',
  'Don’t_have_account' => 'Don’t have account',
  'Ex:_6+_character' => '例: 6+ 字',
  'Forgot_Password' => 'スワードをお忘ですか',
  'or_continue_with' => 'Or continue with',
  'register' => 'Register',
  'First_Name' => 'ファーストネーム',
  'Last_Name' => 'Last Name',
  'Confirm_Password' => 'パスワーを認証する',
  'Sign_Up' => 'サインアップ',
  ...
  'profile' => 'Profile',
  'Edit_Profile' => 'プロファ編集',
  'Delete_My_Account' => 'アカウントを削除しす',
  'Edit_Personal_Details' => '編集 個人 詳細',
  'Go_back' => '戻る',
  'Update_Profile' => 'Update Profile',
  'Wish_List' => 'Wish List',
  'Compare' => '比較する',
  'Loyalty_Point' => 'ロイヤリテ ポイント',
  'Personal_Details' => '個人の詳細',
  'My_Addresses' => '私のアドス',
  'Add_Address' => 'アレスの追加',
  'Home_(Shipping_Address)' => 'ホーム (送先 所)',
  'banner' => 'Banner',
  'banner_URL' => 'Banner URL',
  'addresses' => '住所',
  'My profile' => '私のロフィール',
  ...
  'Ex: 01xxxxxxxxx' => ': 01xxxxxxxxx',
  'Ex: 6+ character' => '例: 6 文字以上',
  'Choose_Label' => 'Choose Label',
  'Contact_Person' => 'Contact Person',
  'Ex:_Jhon_Doe' => '例: Jhon Doe',
  'Ex:_01xxxxxxxxx' => '例: 01xxxxxxxxx',
  'Select_Country' => '国を選択',
  'Select_City' => '都市の選択',
  'Zip_Code' => '郵便番号',
  'Choose_Address_Type' => '住所の種類を選択してください',
  'Ex:_1216_Dhaka' => '例: 1216 ダッカ',
  'Save_This_Address' => 'このドレスを保存',
  'Ex:01xxxxxxxxx' => '例:01xxxxxxxxx',
  'Data_updated_successfully!' => 'データが正に更新れました!',
  ...
  'Unit_Price' => '単価',
  'File type: jpg jpeg png. Maximum size: 2MB' => 'ァイルタイプ：jpg、jpeg、png。',
  'Unit_Price_:' => '単価 ：',
  'pc' => 'Pc',
  'pc_' => 'Pc ',
  '_pc' => 'pc',
  ...
  'Submit_a_review' => 'レビューを送信する',
  'Refund_Request' => 'Refund Request',
  'Refund_reason' => '返金の理由',
  'File_type:_jpg_jpeg_png._Maximum_size' => 'ファイルの種類: jpg jpeg png. 最大サイズ',
  'Coupon_discount' => 'クーポン 割引',
  'Total_refundable_amount' => '返金可能総額',
  'transaction_history' => 'Transaction history',
  'order place' => 'Order place',
  'loyalty point' => 'Loyalty point',
  'Chat_with_Seller' => '販売者とチャットする',
  'Positive_Review' => '肯定的なレビュー',
  'Standard_Delivery' => '通達',
  'Refund_Details' => '金 詳細',
  ...
  'Joined' => '加ました',
  'Show_Order_:' => '表示 注文 :',
  'Don t Delete' => '削除しないくだい',
  'My_Wish_List' => '私のウィッシュリト',
  'Clear_All' => 'Clear All',
  'Update_Deliveryman' => '更新 配員',
  'General_Information' => '一般情報',
  'New delivery-man' => '新しい配達員さん',
  'Last Name' => '苗字',
  'Ex : DH-23434-LS' => '例：DH-23434-LS',
  'Account_Information' => '口座情',
  'third_party_delivery_tracking_id' => 'Third party delivery tracking id',
  'Submit_a_Deliveryman_Review' => 'Submit a Deliveryman Review',
  'Chat_with_delivery' => '達とチャット',
  'Delivered_Orders' => 'Delivered Orders',
  'Leave_a_comment' => 'コントを残す',
  'Chat_with_seller' => '販者とのチャト',
  'Invalid review!' => 'Invalid review!',
  'Product Successfully Returned' => '製品は正常に返されました',
  'assets/img/icons/track4.png' => 'Assets/img/icons/track4.png',
  'assets/img/icons/track5.png' => 'Assets/img/icons/track5.png',
  'Order_placed' => '注文済み',
  'Packaging_order' => '包 注文',
  'Order_is_on_the_way' => '文は途中です',
  'Preparing_for_shipment' => '送手き中',
  'Order_Delivered' => '注文 配達済み',
  'Product_Successfully_Returned' => '品 正常に返品されまた',
  'Sorry_we_can`t_complete_your_order' => '申し訳あませんが、ご注文を完すことはできません',
  ...
  'add_to_wishlist' => 'ほしい物リストに追する',
  'add_to_compare' => 'Add to compare',
  'quick_view' => 'Quick view',
  'top' => 'Top',
  'Seller_Login' => '販売者 ログイン',
  'login_to_your_seller_account' => 'Login to your seller account',
  'Ex:_8+_character' => '例: 8+ 字',
  'Enter_captcha_value' => 'キャプチャ値を入力てくだい',
  'product_edit' => 'Product edit',
  'USE_COUPON' => 'USE COUPON',
  'Customeer_Added_Successfully' => '顧客 追加 功',
  'View_All' => 'すべ表示',
  'Featured_Deals' => 'Featured Deals',
  'Recommended_For_You' => 'あたにおすすめ',
  'Best_Sellings' => 'ベトセラー',
  'Latest_Products' => '最新製品',
  'sorry' => 'Sorry',
  'this_item_is_currently_sold_out' => 'This item is currently sold out',
  'Header Banner' => 'Header Banner',
  'Top_Rated_Products' => 'トッ評価の品',
  'Don’t_Miss_the_Chance' => 'チャンスを逃さなでください',
  'Today’s_Best_Deal' => 'Today’s Best Deal',
  'Update Deal of The Day' => '今日のセール更新',
  'view_cart' => 'View cart',
  ...
  'Shopping_Details' => 'ショッピング 細',
  'empty_Cart' => 'Empty Cart',
  'seller product test' => 'Seller product test',
  'contact_With_Seller' => 'Contact With Seller',
  'Type your message' => 'メッセージを入力しください',
  'sgred' => 'Sgred',
  'variation wise product test' => 'Variation wise product test',
  'seller variation wise product' => 'Seller variation wise product',
  'Item_Price' => '商品 価格',
  'Promo_Code' => 'プロモーションコー',
  'Sub_total' => 'Sub total',
  'free' => 'Free',
  'Continue_Shopping' => 'ショッピグ続ける',
  'Proceed_to_Next' => '次へ進む',
  'write_coupon_code_here' => 'Write coupon code here',
  'Shopping_And_Billing_Details' => 'ショッピグと請求の詳細',
  'Shipping_And_Billing_Details' => '送と請求の詳細',
  'Shipping_Details' => '配送 細',
  'cart' => 'Cart',
  'Delivery_Information_Details' => 'Delivery Information Details',
  'Delivery_Address' => 'Delivery Address',
  'Save_this_Address' => 'このアドレスを保存',
  'Set_Form_Map' => 'セッフォーマップ',
  'Select_From_Saved' => '保存済みら選択',
  'Another_Address' => '別のドレス',
  'Contact_Person_Name' => '連絡先担当者名',
  ...
  'Fill_all_required_fields_of_shipping/billing_address' => '送料/請求先住所のすべての必フィールド入力してくさい',
  'Payment_Information' => '支払報',
  'pay_with_secure_Digital_payment_gateways' => 'Pay with secure Digital payment gateways',
  'Cash_on_Delivery' => '代引換',
  'Digital_Payment' => 'Digital Payment',
  'offline' => 'Offline',
  'Product already added to wishlist' => '製品すでにウィッシュリストに追加されていす',
  'card_holder_name' => 'Card holder name',
  'card_holder_email' => 'Card holder email',
  'security_code' => 'Security code',
  'installments' => 'Installments',
  'configuration_invalid' => 'Configuration invalid',
  'Your_Order_is_Completed' => 'ご文は完了しました',
  'thank_you_for_your_order' => 'Thank you for your order',
  'your_order_is_being_processed_and_will_be_completed_within_3-6_hours' => 'ご注文は処理中であり、3～6 時間以内にする予定です',
  ...
  'Order_Again' => 'もう一度文る',
  'Want_to_order_your_usuals' => 'いつもの商を注したい',
  'Just_reorder_from_your_previous_orders' => '前注文から再注文するだけ',
  'Find' => '探',
  ...
  'Total_Balance' => '総合収支',
  'How_to_use' => '使い方',
  'Earn_money_to_your_wallet_by_completing_the_offer_&_challenged' => 'オファーを完了て、挑戦て財布におを貯めましう',
  'Convert_your_loyalty_points_into_wallet_money' => 'イヤルテポイントをウレットマネーに変換',
  ...
  'Credit' => 'Credit',
  'Total_Points' => '合計',
  'Convert_your_loyalty_point_to_wallet_money.' => 'ロイルティポイントをォレットマネーに変換しす。',
  'Minimum_200_points_required_to_convert' => '変必要な最小ポイント 200 ポイント',
  ...
  'Leave_your_issue' => '自分の問題を残',
  'Update_Address' => '更アレス',
  'Your_account_deleted_successfully!!' => 'あなたアカウントは正に削除されました!!',
  'Seller_Apply' => '販売者 応募',
  'Seller_Registration' => '販売登録',
  'Create_your_own_store.' => '自分だけストア作成します。',
  'Open_your_and_start_selling.' => 'Open your and start selling.',
  'Create_your_own_business' => '自自身のビジネスを作成る',
  'Seller_Information' => '販売者情報',
  ' Jhon' => 'ジョン',
  ' Doe' => 'ド',
  'Enter_email' => 'メーアドレスを力して',
  'Enter_phone_number' => '電話号を入力してください',
  'Enter_password' => 'パスードを入する',
  'Image_Ration' => '像 比率',
  'Image_size_must_be_within' => '画サイズの必須条件',
  ...
  'I_agree_with_the' => '私はそれに同意しま',
  'Please_check_the_recaptcha' => '再キャプチャを確してください',
  'color image' => 'Color image',
  'various product' => 'Various product',
  'Item_has_been_removed_from_cart' => 'カートからアテが削除されました',
  'color wise image' => 'Color wise image',
  'added_to_cart_successfully!' => 'カートに加さました!',
  ...
  'Sidebar Banner' => 'サイバーバナー',
  'Followers' => 'フォロワー',
  'Follow' => 'フォローす',
  'Quick_View' => 'クイックビュ',
  'Search_Product' => 'Search Product',
  'Search_for_items' => 'アイテムの索',
  'Sort_by' => '並べえ',
  'High_to_Low_Price' => '高価格から価格まで',
  'Low_to_High_Price' => '低格から高価格まで',
  'A_to_Z_Order' => 'A to Z Order',
  'Z_to_A_Order' => 'Z to A Order',
  'Show_Product' => '表示 製品',
  'Choose Option' => 'オプションを択してださい',
  'Best_Selling' => 'ベストセラー',
  'Top_Rated' => 'トップレト',
  'Most_Favorite' => '最もお気に入り',
  'More_Categories' => 'その他のカテリ',
  'More_Brands' => 'もと見 ブランド',
  'Ratings' => '評価',
  'Min' => '分',
  'Max' => 'マックス',
  'Grid_View' => 'グリッドビー',
  ...
  'Follow_Complete' => 'フォロー完',
  'Unfollow' => 'フォロを除する',
  'Unfollow_Complete' => 'フォロー解除 ',
  'follow' => 'Follow',
  'View_style_updated' => 'View style updated',
  'best selling' => 'Best selling',
  'best-selling' => 'Best-selling',
  'Go_To_Chatbox' => 'チャットボック移動',
  'My_Inbox' => 'の信箱',
  'No_featured_product_found' => '注目の製が見かりませんでした',
  'No_Featured_Product_Found' => '目の製品が見つかりませんでした',
  ...
  'Want_to_unfollow_this_shop' => 'このショッのフォロを解除したい',
  'Happy_Club' => 'ハッークラブ',
  ...
  'Lets_Shopping_Today' => '今日はショッピングしましょ',
  'Shop_Now' => '今すぐ入',
  'LTR' => 'LTR',
  'RTL' => 'RTL',
  'light' => 'Light',
  ...
  'Product_has_been_added_to_Compare_list' => '製品が比リストに追加されました',
  ...
  'Seller_Reg' => '売者登録',
  'Sign_In' => 'サンイン',
  'Enter_email_or_phone_number' => '電子メルたは電話番号を入力しください',
  'Enjoy New experience' => '新しい験を楽しむ',
  'Captcha_Failed.' => 'キャプチャに失敗しまた。',
  'Terms_&_Policy' => '利用規約 & ポシー',
  'Have_an_Account' => 'アカウトを持っています',
  ...
  'Your_Most_Searching' => 'あなたが最検索しいるもの',
  'Top_Fashion_House' => 'トップ ァッション ハウス',
  'Shop_Again_From_Your_Recent_Store' => '最近使ったストアらも一度購入する',
  'Visit_Again' => 'もう一度訪問',
  'Other s_Store' => 'そ他店舗',
  'Top_Rated_Seller' => 'トップ評価の販売',
  'New_Seller' => '新規 者',
  'Visit_Shop' => '訪 ショップ',
  ...
  'In_Compare' => '比中',
  'My_Order' => '私の文',
  'My_Wishlist' => '私ウィッュリスト',
  'My_Compare_list' => '私の比較リスト',
  'Support' => 'Support',
  'Close_Ticket' => '閉る チケット',
  'Messages' => 'Messages',
  'Search...' => 'Search...',
  'Delivery_Man' => 'Delivery Man',
  'All_Order_List' => 'すての注文リト',
  'Remove_All' => 'すべて削除する',
  'Unit Price' => '単価',
  'Check_Status' => 'ステータの確認',
  'My_Order_Details' => '私の注文の詳細',
  'OnGoing' => '行中',
  'Go Back' => '戻',
  'Zip Code' => '便番',
  ...
  'View_More' => 'もっとる',
  'View_Less' => 'ビューレス',
  'Product_review_not_available' => '製品レビューがありません',
  'Shop_Page' => 'ショップページ',
  'Similar_Category_Product' => '類似の カテゴリ 製品',
  'no_more_review_remain_to_load' => 'No more review remain to load',
  'Search_Products' => '製の検索',
  'User_Not_Exist' => 'ユーザーが存在ない',
  'See_Less' => '見 減らす',
  'TAX Exclude Product TAX Exclude Product TAX Exclude Product TAX Exclude Product' => '税商品 税抜商品 税抜商 税抜商品',
  'Delivery' => 'Delivery',
  'most favorite' => 'Most favorite',
  'product 1' => 'Product 1',
  ...
  'All_Brand' => 'すべのブランド',
  'Newsletter' => 'ニュースレター',
  'Be_the_first_one_to_know_about_discounts' => '割引につい初めて知る人にりまょう',
  'Enter_your_email' => 'メールアドレス入',
  'Payment_Option' => '払い オプション',
  'Price_Range' => '価格帯',
  ...
  'Featured' => '特徴',
  'Most_Loved' => '最も愛されいる',
  'Password doesn t Match' => 'パスワードが一しません',
  'Login_Now' => 'こでログイン',
  'Please_type_verify_code' => 'Please type verify code',
  'Your_password_must_be_at_least_8_characters' => 'あなたのパスワードはなくとも 8 文字なければなりません',
  'Password_doesn t_Match' => 'スワードが一致しませ',
  'Your_order' => 'ご注',
  'is' => 'Is',
  'Order_Created_At' => 'Order Created At',
  'Olga Sheppard' => 'オルガシェパード',
  'My_Address' => '私のアドレス',
  'My_Wishlists' => '私ウィッシュリスト',
  'My_Loyalty_Point' => 'My Loyalty Point',
  'Minimum' => '最小',
  'points_required_to_convert' => 'Points required to convert',
  'Minimum_200_Points_required_to_convert_Into_currency' => '貨に変換するには最低 200 ポイントが必要です',
  'Close_this_ticket' => 'こチケトを閉じる',
  ...
  'Store_Secondary_Banner' => 'ストア センダリ バナー',
  ...
  'Back_Again' => '再び',
  'Saved_Addresses' => '保存済みドレス',
  'Saved Addresses' => 'Saved Addresses',
  'address_added_successfully!' => 'address added 成功しました!',
  'All_Pages_Banner' => 'すべのページ バナー',
  'OTP_and_login_setup' => 'OTP and login setup',
  'OTP_verification' => 'OTP 検証',
  'order_verification' => 'Order verification',
  'account_phone_not_verified' => 'account phone not verified',
  'Customer_Verify' => '顧 検証',
  'OTP_Verification' => 'OTP 検証',
  'Please_Verify_that_it’s_you' => 'それを確認てください',
  'An_OTP_(One_Time_Password)_has_been_sent_to' => 'OTP (ワンタイムパワード)が送信さました',
  'Please_enter_the_OTP_in_the_field_below_to_verify_your_phone' => '電話番号確認するには、下のフィールド OTP を入力してくださ',
  'Resend_code_within' => 'Resend code within',
  'Resend_OTP' => '再送信 OTP',
  'Verification_Successfully_Completed' => '検証 成功 了',
  'Thank_you_for_your_verification' => '証していだきありがとうございます',
  'Now_you_can_login' => '今すぐログンできす',
  'your_account_is_ready_to_use' => 'Your account is ready to use',
  'OTP_has_been_sent_again.' => 'OTP が再送信れました。',
  'please_wait_for_new_code.' => 'Please wait for new code.',
  'Verification code/ OTP mismatched' => '検コード/OTPが一致しん',
  'OTP_setup' => 'OTP セットアップ',
  ...
  'The maximum login hit is a measure of how many times a user can submit password within a time.' => '最大ログイ ヒットは、ユーザー時内にパスワードを信でる回数の尺度です。',
  'temporary_login_block_time' => 'Temporary login block time',
  'Settings updated!' => '設定が更新されまし！',
  ...
  'you_will_lost_the_this_theme' => 'あなたはこのテマを失うしょう',
  'Shop_wise_with' => 'ショッピグワイズウズ',
  'price_comparisons' => 'Price comparisons',
  'Explore_Now' => '今ぐ探索する',
  'Most_Visited_Categories' => 'も訪問されたカテゴリ',
  'Most_Searching' => '最も検索さているもの',
  'Others_Store' => 'その他 店舗',
  'Popular_Tags' => '人気タグ',
  'Upcoming_Campaign' => '今のキャンペーン',
  'All_Brands' => 'すべてのラド',
  'All_products' => 'べての製品',
  'Blog' => 'ログ',
  'About_us' => 'About us',
  ...
  'sell_on' => 'Sell on',
  'Check_now' => 'Check now',
  'Exclusive & Fashionable Suit For Men' => '高級でァッショナブルな男用スーツ',
  ...
  'Artificial Leather Shoes for Men by Mosharrof Shoes' => 'Mosharrof Shoesの男性人工皮革シューズ',
  ...
  'activated_successfully' => 'アクティブ化 成功しました',
  'activation failed' => 'アクィベーョンに失敗しました',
  'Update_this_Address' => 'Update this Address',
  'Invalid Order Id or Phone Number' => '無効な注文 ID または電話番',
  'Delivery_unavailable_in_this_country' => 'Delivery unavailable in this country',
  'Order_Placed' => 'Order Placed',
  'Order_Received_Notify_Seller' => '注文 受信 通知 販売者',
  ...
  'Kids Wood Table and 4 Chair Set Natural Table Assorted Color Chairs' => 'キズウッドテーブル＆チア4脚セット ナチュラテーブル アートカラチェア',
  ...
  'print' => 'Print',
  'This page is for A4 size page printer so it won t be visible in smaller devices' => 'このページはA4サイのページプリンター用すので、型のデバイスでは表示れません',
  'Background Music for commercial use' => '商用利用可能なBGM',
  'system_setup' => 'System setup',
  'Ladies Winter Long Sleeve Sweater' => 'Ladies Winter Long Sleeve Sweater',
  'If the user fails to get the OTP within a certain time user can request a resend' => 'ユーザーが一時間に OTP を取得できかた場合、ユーザーは再信をリクエストできす。',
  'Temporary OTP block time refers to a security measure implemented by systems to restrict access to OTP service for a specified period of time for wrong OTP submission.' => '一時な OTP ブロック時間と、誤った OTP 送信に対て、指定された期間 OTP サービスへのアクセスを制するためにシスムによて実装されるキュリティ対策を指します。',
  'Temporary login block time refers to a security measure implemented by systems to restrict access for a specified period of time for wrong Password submission' => '一時的なグイン ブック時間は、間違ったスワーが送信された場合に、指定された期間クセを制限するためにスムによって実装されるセキュリティ対策をます。',
  'account_email_not_verified' => 'account email not verified',
  'An_OTP_(One_Time_Password)_has_been_sent_to_your_email' => 'OTP (ワンタイムパスワード)があなたのメールに送信されました',
  'Please_enter_the_OTP_in_the_field_below_to_verify_your_email' => '電子メールを確認するには、下のフードに OTP を入力しくだい',
  'Email_Verification' => '電子メール 認',
  'in_seconds' => 'In seconds',
  'instructions' => 'Instructions',
  'Employee_Update' => '従業員 新',
  'Select All' => 'すべて選択',
  'Promotion_Management' => 'Promotion Management',
  'Reports_&_Analytics' => 'レート & 分析',
  'User_Management' => 'ユーー管理',
  'Employee Roles' => '従業員役割',
  ...
  'Are_you_sure_delete_this_role' => 'の役割を削してよろしいですか',
  'Role_deleted_successfully' => '役割 削 成功',
  'Role_Update' => '割 更新',
  'Select_All' => 'すべて選択',
  'reports_and_analytics' => 'Reports and analytics',
  'Add_New_Employee' => '新しい従業員を追加',
  'Full Name' => 'フネー',
  'Confirm Password' => 'スワードを認証する',
  'pos management' => 'Pos management',
  'invalid_theme!' => 'Invalid theme!',
  'Product_List_Page' => '製品一覧ページ',
  'Terms_and_Conditions' => '用規約',
  'Banner Terms Conditions' => 'バナー利用規',
  'Banner Cancellation Policy' => 'バナーキャンセルポシー',
  ...
  'Sneakers man new design fabrics shoes with high lace up design and rubber materi' => 'スーーマンの新しいデザイの生地の靴、高レースアップデザインゴム素',
  'Kevin Barr' => 'ケビン・バール',
  'digital product' => 'Digital product',
  'test product 1' => 'Test product 1',
  'test product 2' => 'Test product 2',
  'Website_Color' => 'ェブサイト ラー',
  'Application System' => 'Application System',
  'First_Shipping' => '最初の発',
  'First_Shipping_all_accross_the_country' => '全国への初の配送',
  'Authentic_Product' => '本物の品',
  '100%_Authentic_Products' => '100% 本物 製品',
  'First_Shipping_all_across_the_country' => '全国への最初の送',
  'Authentic_Products' => '本物製品',
  ...
  'read_more' => 'Read more',
  'all_your_data_are_safe' => 'べてのあなたのデタは安全です',
  ...
  'earnings' => 'Earnings',
  'Refer_&_Earn' => '紹介 & 獲得',
  'Earn_as_Delivery_Man' => '配達員とて稼ぐ',
  'Accept_All_Cookies' => 'すべての Cookie を入れる',
  'About_Our_Company' => '私たちの会社にいて',
  'All_Cart_Product_List' => 'All Cart Product List',
  'Size' => 'サイズ',
  'Totals_Cost' => '合計 コスト',
  'Apply_Coupon_Code' => 'クポンードの適用',
  'Proceed_To_Checkout' => 'チェクアウに進む',
  'Button_Text' => 'Button Text',
  'Enter_button_text' => 'ボタンテキスト入力してくさい',
  ...
  'Chat_with_Delivery_man' => '配達員とチャする',
  'My_Order_Details_Seller_Info' => '私の注文細売者情報',
  'Ladies Bag' => 'レディースバッ',
  'Product_Comparison' => 'Product Comparison',
  'Find_and_select_products_to_see_the_differences_and_similarities_between_them' => '製品を検索して選択し、それらの間の違点と似点を確認しす',
  'Color_Variant' => 'Color Variant',
  'Search_by_Name_or_Category' => '名前またはカテゴリで検索',
  '_Color_Available' => ' カラー あ',
  'no_' => 'No ',
  'no_Rating' => 'No Rating',
  'no_Color' => 'No Color',
  'Store_List' => 'ストアリト',
  'Search_Store' => 'Search Store',
  'Static Stock Limit' => '静的庫制限',
  'Edit_My_Profile' => '私のプロフールを編集する',
  'Go_Back' => 'Go Back',
  'Ex:_Jhone' => 'Ex: Jhone',
  'Ex:_Doe' => '例: Doe',
  'Enter_email_number' => 'Enter email number',
  'Image_Ration_1:1' => '画像 比率 1:1',
  'NB:_Image_size_must_be_within_2_MB' => '注意: 画像サイ 2 MB以内でなければなません',
  'Image_format_-_jpg _jpeg _png' => '画像式  -  jpg jpeg png',
  'Please_ReType_Password' => 'Please ReType Password',
  'Passwords_do_not_match' => 'Passwords do not match',
  'password_Must_Be_6_Character' => 'Password Must Be 6 Character',
  'Passwords_match' => 'スワードが一致する',
  'Physical Product' => '物な製品',
  'Share' => '共',
  'women s shoes' => 'Women s shoes',
  'update_product' => 'Update product',
  '3USB Head Phone' => '3 USB ヘッドフォン',
  'Running Shoes' => 'ラニグシューズ',
  'search_by_brands' => 'Search by brands',
  'Payment_History' => '払歴',
  'Loyalty Point' => 'ロイヤティポイント',
  'Add_New_Card' => 'Add New Card',
  'Start_From' => 'からまる',
  'Hot Selling Sneakers Sneakers Men Casual Shoes Men Fashion Sneakers Fly knit Li' => '熱い販スニーカースニーカー性カジュアシューズ男性ファッシンスニーカフライニット李',
  'checkout_details' => 'Checkout details',
  'Set_from_map' => 'Set from map',
  'Set_Delivery_Address' => '配送住所の設定',
  'Proceed_To_Next' => '次へ進',
  'Fill_all_required_fields_of_shipping_address' => '配送先住所すべての必須フールドを入力してくだい',
  'Select_Payment_Method' => '払い方法の選択',
  'Cash_On_Delivery' => 'Cash On Delivery',
  'Please_contact_with_deliveryman_to_confirm_your_pay_and_receive_your_order.' => '達員に連絡して支払い認し、注文を受け取りす。',
  'Please_confirm_your_verified_account_to_pay_through_your_bank_account' => '銀行座を通じて確認済みのアウントを確認してださ',
  'Pay_with_secure_Digital_payment_gateways' => 'Pay with secure Digital payment gateways',
  'order_complete' => 'Order complete',
  'Thank_you_for_your_order!_Your_order_is_being_processed_and_will_be_completed_within_3-6 hours._You_will_receive_an_email_confirmation_when_your_order_is_completed.' => '注文あがとうございす。ご注文は処理中です。3 ～ 6 時間以内に完了しますご注文が完したら、確メールをけ取ります。',
  'My_Order_Details_Track_Order' => 'My Order Details Track Order',
  'Order_delivered' => '文 配達済み',
  'Enter_your_order_ID_& _phone_to_get_delivery_updates' => '注文ID と話番号入力して配信更情報取得してください',
  'Track_Order_Result' => 'Track Order Result',
  'add_Address' => '追加アドレス',
  'Ex:_01XXXXXX' => '例: 01XXXXXX',
  'Enter_Your_City' => 'あなの市を入力してください',
  ...
  'Minimum_' => '最小',
  '_points_required_to_convert_into_currency' => 'への変換に必要なポイ',
  'Convert_to_Currency' => '通貨に変換',
  'Point_Transaction_History' => 'ポイト ランザクション 歴',
  'Support_Ticket_Inbox' => 'サートチケット受箱',
  'start_typing...' => 'Start typing...',
  'brand_List' => 'Brand List',
  ...
  'Order_Complete' => '注文完了',
  'your_order_is_being_processed_and_will_be_completed_within_3-6_hours.' => '注文は処理で、3 ～ 6 間以内に了する予定で。',
  'you_will_receive_an_email_confirmation_when_your_order_is_completed.' => 'You will receive an email confirmation when your order is completed.',
  'My_profile' => 'My profile',
  'Show_Order' => '表示順序',
  'Shipping_Fee' => '送料 手数料',
  'Discount_on_product' => '製品の割引',
  'Sorry_Out_of_stock' => '申し訳ありせんが庫切れです',
  'Type_your_message' => 'メッセジを入力してください',
  'Choose_Option' => 'オプョンの選択',
  'Online_Shopping' => 'オンラインシッピグ',
  'Just_reorder_from_your_previous_orders.' => '前の文から再注文するだす。',
  'Do_not_Miss_Todays_Deal' => '今日の取引を見さないでください',
  'Let_us_Shopping_Today' => '今ョッピングしましょう',
  ...
  'used' => 'Used',
  'Coupon_added_successfully' => 'クーポン 追加 成しした',
  ...
  'discount_amount_is_required' => 'Discount amount is required',
  'minimum_purchase_is_required' => 'Minimum purchase is required',
  'Coupon_updated_successfully' => 'クーポ 更新 成功しました',
  'address_not_found' => 'アドスが見つかません',
  ...
  'Order_Wise_Shipping_Method_deleted_successfully' => 'Order Wise  Shipping Method deleted successly',
  'no_delivery_man_assigned_yet' => 'No delivery man assigned yet',
  'SMS_Module_Setup' => 'SMS モジュー セットアップ',
  ...
  'NB_:_XXXX_will_be_replace_with_otp' => '注 : XXXX will be replace with otp',
  ...
  'Copied_to_the_clipboard' => 'クリッボーにコピーされました',
  ...
  'Go_to_the_Credentials_page' => '認証情報ペジに移動',
  ...
  'Do_not_Logout' => 'ログアウトしないでくい',
  'messages.apple' => 'Messages.apple',
  'Login Turned ON ' => 'ログインがオンなりました',
  'Login Turned OFF ' => 'ログインがフなりました',
  'Login is now enabled. Customers will be able to sign up or log in using their social media accounts.' => 'これでログインが効にりました。',
  'Login is now disabled. Customers will not be able to sign up or log in using their social media accounts. Please note that this may affect user experience and registration/login process.' => '在、ログインは無効になってます。',
  'Credential Setup' => '資格情報のセットップ',
  ...
  '(Already Exists)' => 'もう存在してる）',
  'messages.save' => 'Messages.save',
  'messages.apple_api_set_instruction' => 'Messages.apple api set instruction',
  'Go to Apple Developer page' => 'Apple 開者ページに動します',
  'messages.click_here' => 'Messages.click here',
  'Here in top left corner you can see the' => 'ここの左隅に、',
  'Team ID' => 'ームID',
  '[Apple_Deveveloper_Account_Name - Team_ID]' => '[Apple 開発者 アカント - チーム ID]',
  'Click Plus icon - select App IDs - click on Continue' => 'プラアコンをクリックし、リIDを選択し、続行をックします。',
  'Put a description and also identifier (identifier that used for app) and this is the' => '説明と識別子（アプリに使用れ識別子）を入力すと、れが',
  'Click Continue and Download the file in device named AuthKey_ID.p8 (Store it safely and it is used for push notification)' => '[続行] クリッし、AuthKey ID.p8 という前のファイルをデバイスにダウンロドします (安全に保存、プッシュ知に使用ます)。',
  'Again click Plus icon - select Service IDs - click on Continue' => 'もう一プラスアイコンクリックし、サービスIDを選択し、続行をクリックます。',
  'Push a description and also identifier and Continue' => '説明と識別子をッシュして続行しま',
  'Download the file in device named' => 'という名前のバイスにファイルをダロードします',
  ...
  'Customers will not be able to select COD as a payment method during checkout. Please review your settings and enable COD if you wish to offer this payment option to customers.' => 'お様はチェックアウト時支払い方として代金引換を選択ることはきません。',
  'compare' => 'Compare',
  ...
  'Secret Covered in Sand Comic book pdf' => '砂に覆われ秘密 コミックブク pdf',
  'total_price_for_this_product' => 'Total price for this product',
  'you_can_check_our' => 'You can check our',
  ...
  'your_order_is_being_processed_and_will_be_completed_within_3-6 hours._you_will_receive_an_email_confirmation_when_your_order_is_completed.' => 'ご注文は処理中であ3 ～ 6 時間以内に完了す。ご注文が完了しら、確認メールを受け取ます。',
  'previous' => 'Previous',
  'search_by_order_ID' => 'Search by order ID',
  ...
  'this_shop_is_temporary_closed_or_on_vacation' => 'This shop is temporary closed or on vacation',
  'you_cannot_add_product_to_cart_from_this_shop_for_now' => 'You cannot add product to cart from this shop for now',
  '15 IN 1 MAKEUP COMBO SET WITH FULL MAKEUP COVERAGE set' => '15 IN 1 メクアップ コンボ セッ (フル メイクアプ カレッジ セットき)',
  'Chicken and Egg Puppy Dog Food 400g' => 'チキン＆エッグ パピー ドッグフード 400g',
  'Ava Professional Hair Straightener - Black color' => 'Ava ロフェッショナル ストレートヘアアロン - 黒',
  'Silicone Strap Analogue Sports Watch Rectangular Dial New Model 2023 Men Watches' => 'シリコンストップアナロスポーツウォッチ長方ダイヤ新モデル 2023 メンズ腕計',
  'online_Shopping' => 'Online Shopping',
  ...
  'Password_Reset_Mail' => 'パスワード リセ メール',
  'Configuration_updated_successfully' => '構 新 成功しました',
  ...
  'copied' => 'Copied',
  'Coupon_status_updated' => 'クーポンステタス更新済み',
  'shop_Page' => 'Shop Page',
  ...
  'add_New_Product' => '新しい品を追',
  'product Name' => 'Product Name',
  'product Type' => 'Product Type',
  'show_as_featured' => 'Show as featured',
  'Status_updated_failed.' => 'ステタス更新失敗',
  'Product_must_be_approved' => '製品の承認が必要です',
  ...
  'image_type_must_be_within' => 'Image type must be within',
  'Ex_:_Shop_-12_Road-8' => ': ショップ -12 道路-8',
  'overall_Statistics' => 'Overall Statistics',
  'out_For_Delivery' => 'Out For Delivery',
  'seller_Wallet' => 'Seller Wallet',
  'withdrawable_balance' => 'Withdrawable balance',
  ...
  'product_Reviews' => 'Product Reviews',
  'delivery-Man' => 'Delivery-Man',
  'Reports_&_Analysis' => 'レポト & 分析',
  'emergency_Contact' => 'Emergency Contact',
  'copyright' => 'Copyright',
  'select_Logout_below_if_you_are_ready_to_end_your_current_session' => 'Select Logout below if you are ready to end your current session',
  'you_have_new order' => '新しい注文がりま',
  'check_Please' => 'Check Please',
  'shop_view' => 'Shop view',
  'shop_Info' => 'Shop Info',
  'by_turning_on_temporary_close_mode _your_shop_will_be_shown_as_temporary_off_in_the_website_and_app_for_the_customers._they_cannot_purchase_or_place_order_from_your_shop' => 'By turning on temporary close mode  your shop will be shown as temporary off in the website and app for the customers. they cannot purchase or place order from your shop',
  ...
  'Website_problem' => 'ウサイトの問題',
  'Info_inquiry' => 'Info お問い合わせ',
  'flash_Deal' => 'Flash Deal',
  ...
  'Waltro Vivobook X515ea intel core i3 1115g4 4GB DDR4 Ram 512GB' => 'Waltro Vivobook X515ea インテル core i3 1115g4 4GB DDR4 Ram 512GB',
  ...
  'resend' => 'Resend',
  'you_will_not_be able_to_revert_this' => 'こを元に戻すことはできません',
  ...
  'Ex: John Doe' => '例: ジョン・ドゥ',
  'Ex: 32416436546' => '例: 32416436546',
  'Ex: Dhaka' => '例: ダッカ',
  'Ex: 1216' => '例: 1216',
  'Ex: Street 1 Street 2 Street 3 Street 4' => '例: トリート 1 トリート 2 ストリート 3 ストリート 4',
  ...
  'you_want_to_remove_all_items_from_cart' => 'カートらすべてのアイテムを削除した',
  'product_quantity_is_not_enough' => 'Product quantity is not enough',
  'product_quantity_can_not_be_zero_or_less_than_zero_in_cart' => 'Product quantity can not be zero or less than zero in cart',
  'product_quantity_updated' => 'Product quantity updated',
  'sorry_product_out_of_stock' => 'Sorry product out of stock',
  'Product_quantity_can_not_be_zero_or_less_than_zero_in_cart' => 'カートの製品数量をゼロにすることできません、まはゼ未満にすることはきません',
  'Product_quantity_updated' => '製品数量 新済み',
  'wc-327479' => 'Wc-327479',
  'wc-327477' => 'Wc-327477',
  '10% OFF' => '10％フ',
  'total_Price' => 'Total Price',
  ...
  'Want_to_delete_this_item' => 'のアイテムを削除しい',
  ...
  'add_a_abel_(Ex:_abc_company)' => 'add a abel (例: abc company)',
  'select_reCAPTCHA_v2_as_ReCAPTCHA_Type' => 'Select reCAPTCHA v2 as ReCAPTCHA Type',
  ...
  'Want_to_enable_the_Maintenance_Mode' => 'メンテナスモードを有効にした',
  'Want_to_disable_the_Maintenance_Mode' => 'メンテナスモードを無効にした',
  ...
  'Maintenance_Mode' => 'メンテナンスモド',
  'ON' => 'の上',
  'all_your_apps_and_customer_website_will_be_disabled_until_you_turn_this_mode_OFF' => 'すべてアプリと顧客のウェブイトはこのモードをオフにすまで無効になりす',
  ...
  '* multiple_zip_codes_can_be_inputted_by_comma_separating_or_pressing_enter_button' => '* カンマ区切または入力ボタン押すことで複数の郵便を入力できます',
  ...
  'your_order_has_been_placed_successfully' => 'Your order has been placed successfully',
  'you_order_has_been_confirmed_and_will_be_shipped_according_to_the_method_you_selected' => '注文は確認済みであ、択した方法に従っ発送されます',
  'order_No' => 'Order No',
  'my_Order' => 'My Order',
  ...
  'track_Order_Result' => 'Track Order Result',
  'Invalid Phone Number' => '効な電話番号',
  'Enter_your_order_ID_&_phone_to_get_delivery_updates' => '注文IDと電話番号を入力して配信新情報を取得しくださ',
  'no_review' => 'No review',
  'limited_stock' => 'Limited stock',
  ...
  'your_order_placed_successfully' => '文が成功しまた',
  ...
  'you_have_to_input_all_the_banners_again_for_each_section' => '各セショのバナーをすべて力る必要があります',
  ...
  'after_changing_any_theme_in_the_you_will_a_menu_option_with_the_menu_name.' => 'メニュー変更後のテーマのメニューオプション。',
  ...
  'after_switching_the_theme_a_menu_will_appear_in_the_side_bar_with_the_theme_name_on_it' => 'テーマを切り替え、テーマ名とともにイバーにメニューが表示されます',
  'you_can_setup_theme_wise_required_data_from_there.' => 'You can setup theme wise required data from there.',
  'you_have_switched_theme_successfully' => 'テーマのり替が成功しました',
  ...
  'Promotional_Banners' => 'プモーシン バナー',
  'In-House_Store_Banner' => '社 店舗 バー',
  ...
  'skip' => 'Skip',
  'Menu' => 'メニュー',
  'Most_Demanded_Product' => '最も需のある製品',
  ...
  'delivery_Man' => 'Delivery Man',
  'customer_Wallet' => 'Customer Wallet',
  'admin_can_set_whether_wallet_will_be_available_on_customer_profile_by_enabling_or_disabling_this_button' => '管理は、このボタの有効または無効化にり、顧客プロファイルでウレットが利用可能なかどうかを設定できす',
  ...
  'customer_Loyalty_Point' => 'Customer Loyalty Point',
  'admin_can_set_whether_customers_will_get_loyalty_points_by_enabling_or_disabling_this_button' => 'admin can set customers will get loyalty points by enable or disabling this button',
  ...
  'admin_can_set_whether_customers_will_get_refund_amount_to_wallet_by_enabling_or_disabling_this_button' => '管理者は、このボタの有効化または無効化より、顧客がウォレッの返金金額を取得するどうかを設定できす',
  ...
  'admin_can_set_whether_customers_can_add_money_to_their_wallets_by_enabling_or_disabling_this_button' => '管理者は、このボンを効にするか無効にするとで、顧客が布にお金を追加できるどうかを定できます',
  ...
  'Axxelus' => 'クセルス',
  'Vivatiqo' => 'ビバティコ',
  'Digital Product House' => 'デジタ ロダクト ハウス',
  'Women s fashion' => '女性のフション',
  'Men s fashion' => 'メンズファッショ',
  'Outdoor Fun & Sports' => 'アトドアの楽しみとポーツ',
  'Toys Kids & Babies' => 'おもちゃ キッズベビー',
  'Jewelry & Watches' => 'ジュエリーと時計',
  'Beauty Health & Hair' => '美容と康と髪',
  'Home Improvement & Tools' => 'ホーセンターと工具',
  'Computer Office & Security' => 'コンピューーオフィスセキュリテ',
  'Phones & Telecom' => '話と通信',
  'Bags & Shoes' => 'バッグシューズ',
  'Home Pet & Appliances' => 'ホムペッ&家電製品',
  'eBook' => 'EBook',
  'Applications' => 'アリケーション',
  'sub_categories' => 'Sub categories',
  'all_sub_categories' => 'すべてのサブカテゴリ',
  'Shoes' => 'Shoes',
  'Dress' => 'ドレス',
  'Jewelry' => 'ュエリー',
  'Watches' => '時計',
  ...
  'sub_sub_categories' => 'Sub sub categories',
  'all_sub_sub_categories' => 'すべてのサブカテゴリー',
  ...
  'Easy Electronics' => 'イーーエクトロニクス',
  'Digital Spot' => 'デジタルスポット',
  'Electronic Agile' => '子アジャイル',
  'Bazaar' => 'バザール',
  'B. Store' => 'B. ストア',
  ...
  'Eratmart' => 'ラトマート',
  'cgbfghnb' => 'Cgbfghnb',
  'Order_is_already_delivered_and_transaction_amount_has_been_disbursed_changing_status_can_be_the_reason_of_miscalculation' => '注文は配達済みであり、引金額は払い済みでテータスが更されており、計算ミスの可能があります',
  'reorder' => 'Reorder',
  'Reorder' => '再注文',
  'my_Wallet' => 'My Wallet',
  ...
  'admin_also_rewards_their_top_customers_with_wallet_money' => 'admin only rewards their top customers with wallet money',
  'send_your_wallet_money_while_order' => 'Send your wallet money while order',
  'the_amount_needs_to_be_between' => 'The amount needs to be between',
  'add_fund_to_wallet_success' => 'ウォレットに資を追する 成功',
  'old' => 'Old',
  'check_all_order' => 'Check all order',
  'add funds to wallet' => 'ウォレット資を追加する',
  ...
  'B. Technology' => 'B. テクロジー',
  'Connection' => '繋がり',
  'Camera Accessories' => 'カメラアクサリ',
  'Gadgets' => 'ガジェット',
  'Laptop Tabs & Notebooks' => 'ラップトップタブとノートブック',
  'Smartphone' => 'スマートォン',
  'Network Components' => 'ネットークコンポーネント',
  'Computer & Office' => 'コンュータ＆務所',
  'Mobile Accessories' => 'モバイルクセサリ',
  'TV & Home Appliance' => 'レビと家電製',
  'Audio' => 'オーディ',
  'Wearable' => 'ウェアブル',
  'Consumer electronics' => '家電',
  'Headphones' => 'ヘッフォン',
  'Charger' => '電器',
  'Cable & Converters' => 'ケーブルとコンータ',
  'Bluetooth Speaker' => 'ブルートゥーススピー',
  'Phone Case' => '電ケース',
  'Wireless Earbuds' => 'ワイヤレスイヤホ',
  'Microphones' => 'マイ',
  'Television' => 'テレビ',
  'Refrigerator' => '冷蔵',
  'Microwaves' => '電子レジ',
  ...
  'Webcam' => 'Webcam',
  'Man Watch' => 'マンウォッチ',
  'Ladies Watch' => 'レディースォッ',
  'Smart Watch' => 'スマトウォッチ',
  'Laptop cooler' => 'ラップトプクーー',
  'Hard disk' => 'ハードディスク',
  'Computer Ram' => 'コンピュターのラ',
  'Power supply unit' => '源ユニット',
  'SSD' => 'SSD',
  'Digital Files' => 'デタルファイ',
  'Classic' => 'クラシク',
  'Internet Cable' => 'ンターネットケブル',
  'Gamming Laptop' => 'ゲーングノートパソコン',
  'Central Air Conditioner.' => 'セントラルエアコ。',
  'Geothermal Air Conditioner' => 'Geothermal Air Conditioner',
  'Portable Air Conditioner' => 'ポータブルエアン',
  'Top Freezer Refrigerator' => 'トップフリーザー冷蔵庫',
  'Digital Watches' => 'ジタル時計',
  'Wireless' => '無線',
  'Mechanical' => '機械式',
  'Double Fan' => 'ブルファン',
  'want_to_delete_this_item ' => 'Want to delete this item ',
  ...
  'Once_you_convert_the_point_into_money_then_it_won`t_back_to_point' => '一イントをお金に変換すると、その後はポイト戻ることはありまん',
  ...
  'admin_can_set_whether_deliveryman_needs_to_upload_the_picture_of_delivery_by_enabling_or_disabling_this_button' => '管理者は、このボタンを有効するか効にすること、配達員配達の写真をアップロードする必があるかどかを設定きます',
  ...
  '_as_the_Digital_Payment_method' => ' デジタル支払い方法とて',
  ...
  '_again_ _you_will_see_the_saved_data.' => '保存されデータをもう一度見ましょう。',
  ...
  'If_disabled_sellers_can_not_sell_digital_products_in_their_shops' => '無効な販売者が自分ショプでデジタル製品を販できない場合',
  'If_enabled_sellers_can_sell_digital_products_in_their_shops' => '有な販売者が自分のショプでデジタル品を販売できる場合',
  'show_brand' => 'Show brand',
  ...
  'Add_dynamic_url_to_secure_admin_login_access.' => 'Secure admin login access 動的 URL を追加します',
  'employee_Login_Page' => 'Employee Login Page',
  'employee_login_url' => 'Employee login url',
  'Add_dynamic_url_to_secure_employee_login_access.' => 'Secure employee login access に動的 URL を追します。',
  'Updated_unsuccessful' => '更新済み 失敗',
  'minimum_Order_Amount' => 'Minimum Order Amount',
  ...
  'after_uploading_products_you_need_to_edit_them_and_set_product_images_and_choices.' => '製品のアップロド後、製品の集と製品画像と選択の定が要です。',
  ...
  'Settings_updated' => '設定が更されました',
  'Message_updated' => 'メッセージ 更済み',
  ...
  'To_visit_your_currently_active_sms_gateway_settings_please_follow_the_link.' => '現在アティブなSMSゲートウイ設定にアクセスする、リンクをたどってださい。',
  ...
  'SMS_gateway_title' => 'SMS ゲトウイ タイトル',
  'SMS_Gateway_Title' => 'SMS ゲトウェ タイトル',
  '_as_the_SMS_Gateway' => 'SMS ゲートウイとして',
  ...
  'The_file_upload_field_is_required' => 'ファイルアップロードフィルドは必須で',
  ...
  'TAX Include Product TAX Include Product TAX Include Product TAX Include Product' => '消税には製品含まれます 消費税に製品が含まれす 消費税には製品がまれま 消費税には製品が含まれます',
  'customer_Information' => 'Customer Information',
  'edit_Customer' => 'Edit Customer',
  'tag' => 'Tag',
  'Customer_review' => 'カスマービュー',
  'OFF' => 'OFF',
  'now' => 'Now',
  'add_fund_to_wallet' => 'ウォレッに金を追加',
  'and_enjoy' => 'And enjoy',
  'bonus' => 'Bonus',
  'all_Transactions' => '取引',
  ...
  'qwertyu' => 'Qwertyu',
  'Theme Changed to Theme Aster' => 'ーがテーマ Aster に変更されました',
  'Theme Changed to Theme Fashion' => 'テマがァッションのテーマに変更されました',
  'all_brands_page' => 'すべのブラドページ',
  ...
  'add_the_purchase_price_for_this_product' => 'この製の購入価格を追加',
  ...
  'add_the_Stock_Quantity_of_this_product_that_will_be_visible_to_customers' => '顧客表示さるこの製品の在数量を追加',
  ...
  'add_the_discount_amount_in_percentage_or_a_fixed_value_here' => 'ここに割額を割合または固値追加します',
  ...
  'add_your_product’s_thumbnail_in' => 'add your products thumbnail in',
  ...
  'add_the_YouTube_video_link_here._Only_the_YouTube-embedded_link_is_supported' => 'add the YouTube video link here.YouTube め込みリンクのみ ポートされています',
  ...
  'add_a_label_(Ex:_abc_company)' => 'add a label (例: abc company)',
  ...
  'admin_will_handle_the_shipping_responsibilities_when_you_choose_inhouse_shipping_method' => 'inhouse shipping method を選択した場合、理者配送責任を処理します',
  'Want_to_change_the_shipping_responsibility_to_Inhouse' => 'Want to change the shipping responsibility to Inhouse',
  ...
  'deleted!' => 'Deleted!',
  'cancelled' => 'Cancelled',
  'you_do_not_have_sufficient_balance_for_pay_this_order!!' => 'この文の支払いに十分な残がありまん!!',
  'Deluxe Online Deluxe' => 'デラッス オンライ デラッス',
  'deliveryman_review' => 'Deliveryman review',
  ...
  'Deluxe Online Deluxe Online' => 'デックス オンライ デックス オンライン',
  'No_Order_Found' => '注文つかりませんでした',
  'Want_to_Turn_ON_Coupon_Status' => 'ONにしたいクーポンステータス',
  'Want_to_Turn_OFF_Coupon_Status' => 'OFFしいクーポンのステタス',
  ...
  'Want_to_Turn_ON' => 'ONにしたい',
  'Want_to_Turn_OFF' => 'オフにしたい',
  ...
  'London Beauty Soap Bar' => 'ロンドンューテーソープバー',
  'all_store' => 'すべてのストア',
  'no_country_to_deliver' => 'No country to deliver',
  'Want_to_Turn_ON_Offline_Payment_Methods' => 'オフライでの支払方法をオンしたい',
  ...
  'Theme Changed to Default' => 'ーマがデォルトに変更れまし',
  'urway' => 'Urway',
  ...
  'you_will_lost_the_this' => 'あなたはこれを失うでしょう',
  ...
  'after_reaching_this_limit_the_user_will_be_blocked_for_a_time' => 'この制限に達した後、ーーは一定期間ブロクさます',
  '(sec)' => '(秒)',
  'set_the_time_for_requesting_a_new_OTP' => 'Set the time for requesting a new OTP',
  'Within_this_time_users_can_not_make_OTP_requests_again' => 'の時間では、ユーザーは再度 OTP リクエストを作成できません',
  'ex: 120' => 'Ex: 120',
  ...
  'after_reaching_this_limit_they_will_be_blocked_for_a_time' => 'この限に達した後は、一定期間ブロックれることなります',
  ...
  'Want_to_Turn_ON_Deliveryman_Status' => 'オにしたい配員のステタス',
  'Want_to_Turn_OFF_Deliveryman_Status' => '配達員ステータスをオフにしい',
  ...
  'This_phone_number_is_already_taken' => 'この電話番はすでに使用されています',
  'Coupon_deleted_successfully' => 'クーポン 削除 成功ました',
  'Want_to_Unlock' => 'Want to Unlock',
  'Want_to_Block' => 'ブロックした',
  ...
  'Variation_Wise_Stock' => 'バリエーション ワ ストック',
  'Upload_Image' => '画像のアップロー',
  ...
  'Want_to_Turn_ON_Deal_of_the_Day_Status' => 'その日の取引テータスをオンにした',
  'Want_to_Turn_OFF_Deal_of_the_Day_Status' => 'その日取引ステータスをオフしたい',
  ...
  'Want_to_Turn_ON_Flash_Deal_Status' => 'ンにしたい Flash Deal Status',
  'Want_to_Turn_OFF_Flash_Deal_Status' => 'フラッシュ引ステースをオフにしたい',
  ...
  'add_the_products_title_name_taglines_etc_here' => '製品のタイトル名タグインなどをこに追加',
  ...
  'Notification_Sent_to_All_Sellers_Fail' => 'すべの販者に通知が送信されまんでした 失敗',
  'Notification_Sent_to_All_Sellers' => 'すべての販売者に通知送信',
  'Amazon Pro' => 'ゾンプロ',
  'Want_to_enable_the_Temporary_Close' => '時に閉じることを有にしたい',
  'Want_to_disable_the_Temporary_Close' => '一時的閉じるを無効にたい',
  ...
  'OTP_sent_successfully._Please_check_your_email_or_phone' => 'OTP は常に送信されました。電子メーまたは電話号を確認しください',
  'Deliveryman_Password_Reset_Mail' => 'Deliveryman Password Reset Mail',
  'OTP for Reset Password' => 'パスワードをリセットするめの OTP',
  ...
  'Secure_Payment' => '安なお支払',
  'see_less' => 'See less',
  'Customers_will_not_be_able_to_select_COD_as_a_payment_method_during_checkout' => '顧客はェックアウト中支払方法として代金引換を選択できません',
  ...
  'Features_Section' => '能 セクション',
  'view_All_Hold_Orders' => 'View All Hold Orders',
  'add_New_Customer' => 'Add New Customer',
  'clear_Cart' => 'Clear Cart',
  'new_Order' => 'New Order',
  'announcement_Setup' => 'Announcement Setup',
  'Want_to_Turn_ON_Language_Status' => 'オンにしたい言語ステータス',
  'Want_to_Turn_OFF_Language_Status' => '言をオフにしたい ステータス',
  ...
  'No_data_found' => '何もデータが見つかせんでした',
  'No_matching_data_found' => '一致すデタは見つかりませでし',
  ...
  'you_want_to_change_refund_status' => '返金テータスを変更たい',
  'refund_status_updated_successfully' => 'Refund status updated successfully',
  ...
  'FAQ_deleted_successfully' => 'FAQ 削除 功',
  ...
  'your_order_is_being_processed_and_will_be_completed_within_3_to_6_hours' => 'ご注文は理中であり3 時間か 6 時間以内に了する予定です',
  ...
  'add fund bonus categ...' => 'ファンドボーナスカテゴを追加...',
  ...
  'Want_to_Turn_OFF_Push_Notification' => 'プッシ通知オフにしたい',
  ...
  'Deliveryman_Start_Message' => '配達員 開始 メセージ',
  'Deliveryman_Delivered_Message' => 'Deliveryman Delivered Message',
  'Deliveryman_Reschedule_Message' => '配員 再スケジュール メセージ',
  'Want_to_Turn_ON_Notification_Status' => '通知オにしたい ステース',
  'Want_to_Turn_OFF_Notification_Status' => '通知をオフにしい ステータス',
  ...
  'Want_to_Turn_ON_Customer_Reviews' => 'ONにたい顧客レビュー数',
  'Want_to_Turn_OFF_Customer_Reviews' => '顧客ビューをフにしたい',
  ...
  'Want_to_Turn_ON_Employee_Status' => 'オンにたい従員のステータス',
  ...
  'OTP_Verification_Code' => 'OTP 検証 コード',
  'your_OTP_Verification_Code' => 'Your OTP Verification Code',
  'feature_Deal' => 'Feature Deal',
  'feature_deal_Table' => 'Feature deal Table',
  'search by Title' => 'Search by Title',
  'Want_to_Turn_ON_Featured_Deal_Status' => 'オンにしたい 目の取引ステータス',
  'Want_to_Turn_OFF_Featured_Deal_Status' => 'オフにしたい 注目の引ステータス',
  ...
  'Feature_Deal' => '特集 セール',
  'Feature_Deal_for_this_season' => '今シーズンの特集セー',
  ...
  'Want_to_Turn_ON_Most_Demanded_Product_Status' => 'ON にしたい 最も需要のある製品スータス',
  'Want_to_Turn_OFF_Most_Demanded_Product_Status' => 'OFFにしたい Most Demanded Product Status',
  ...
  'Sorry_the_minimum_value_was_reached' => '申し訳ありませんが小値に達しました',
  'Sorry_stock_limit_exceeded' => 'し訳ありませんが stock limit exceeded',
  ...
  'Withdraw_request_has_been_sent' => '引き出し要求が送されました',
  'seller_Withdraw_Information' => 'Seller Withdraw Information',
  'Seller_Payment_has_been_approved_successfully' => '販売者の支払が承されました 成功しまた',
  'out for delivery' => 'Out for delivery',
  'don t_miss_todays_deal' => 'Don t miss todays deal',
  'admin_bonus' => '理者ボーナス',
  'followed' => 'Followed',
  123456 => '123456',
  'add_new_field' => 'しいフィールド追加',
  ...
  'from_Date' => 'From Date',
  'Seller_has_been_approved_successfully' => '販売者は承済みです',
  ...
  'sub_Sub_Category_Deleted_Successfully' => 'Sub Sub Category Deleted Successfully',
  'sub_Sub' => 'Sub Sub',
  'Category_added_successfully' => 'カテゴリ追加 功',
  'Category_updated_successfully' => 'カゴリ 更新 功しまし',
  'category_updated_successfully' => 'Category updated successfully',
  'sub_category_Image' => 'Sub category Image',
  'Admin_also_reward_their_top_customers_with_wallet_money' => '管者も、財布を持たトプ顧客に報酬を与える',
  'You_do_not_have_any' => 'なたは何も持っていません',
  'transaction_yet' => 'Transaction yet',
  'This_shop_is_temporary_closed_or_on_vacation' => 'このショップは臨時休業または休暇中',
  'Chat_with_us_on_WhatsApp' => 'WhatsApp でチャットする',
  'Please_review_the_ratio_before_upload' => 'Please review the ratio before upload',
  'you_do_not_have_any' => 'あな何も持っていません',
  'cannot_input_minus_value' => 'Cannot input minus value',
  'order_number' => 'Order number',
  'no_Transaction_Found' => 'No Transaction Found',
  'Ex:_7+ character' => '例: 7+ 文字',
  'Ex:_7+_character' => '例: 7+ 字',
  ...
  'Your current payment settings are disabled because you have enabled payment gateway addon To visit your currently active payment gateway settings please follow the link.' => '払ゲートウェイ アオン有効にしているめ、現の支払い設定は無効になっています 現在有効支払いゲートウェイ設定にアクセするには、ンクをクックしてくだい。',
  'addon_Menus' => 'ドオンメニュー',
  'Sorry_stock_limit_exceeded.' => '庫制限超えてしまいまた。',
  ...
  'Language_Added' => '言語 加済み',
  'Default_Language_Changed' => 'デフォルト言語変更されました',
  ...
  'Product_added_successfully' => '品追加に成功しました',
  'account _number' => '口座号',
  'select_Date_Type' => 'Select Date Type',
  'Image_Not_found' => 'Image Not found',
  'Digital_file_upload_successfully' => 'デジタルファイルアップロードに成功しし',
  'default-currency_setup' => 'Default-currency setup',
  'add_currency' => '通貨追加',
  'add_the_name_of_the_currency_you_want_to_add' => '加した通貨の名前を追加',
  'add_the_symbol_of_the_currency_you_want_to_add' => 'Add the symbol of the currency you want to add',
  'add_the_code_of_the_currency_you_want_to_add' => '追加たい通貨のードを追加',
  'Want_to_Turn_ON_Currency_Status' => 'オにしたい通貨ステータ',
  'Want_to_Turn_OFF_Currency_Status' => '通貨テータスをオフにした',
  ...
  'Jhone' => 'ジョー',
  880 => '880',
  'OTP_has_been_sent_again' => 'OTPが再送信されました',
  'please_wait_for_new_code' => 'Please wait for new code',
  'password_does_not_Match' => 'Password does not Match',
  'you_can_review_after_the_product_is_delivered' => 'You can review after the product is delivered',
  'you_can_refund_request_after_the_product_is_delivered' => 'You can refund request after the product is delivered',
  'pi 3NzHbf2eZvKYlo2C098tVr0K' => 'Pi 3NzHbf2eZvKYlo2C098tVr0K',
  'No_data_found_for_export' => 'エクスポート用のータが見つかりまんでした',
  'ame' => 'Ame',
  'add_new_contact_information' => '新しい連絡先情報追加',
  'contact_name' => 'Contact name',
  'contact_information_Table' => 'Contact information Table',
  'Want_to_Turn_ON_Support_Ticket_Status' => 'サポーをオンにしたい チケ ステータス',
  'Want_to_Turn_OFF_Support_Ticket_Status' => 'サポートをオフにた チケット ステース',
  ...
  'System_Default_currency_updated_successfully' => 'System Default currency updated completely',
  'Add_Fund_To_Wallet' => 'Add Fund To Wallet',
  'welcome' => 'Welcome',
  'Transaction Sucessfull' => 'トランザクシンが成功しまし',
  'amount sucessfully credited to your wallet' => 'Amount sucessfully credited to your wallet',
  'Rewared by company admin' => '会社管理者から表彰されまた',
  'dear' => 'Dear',
  ...
  'my_support_tickets' => 'My support tickets',
  'you_will_get_response_soon' => 'すぐに応答が得られます',
  ...
  'Okay' => 'わかった',
  'Your_Cart_is_Empty' => 'あなたカートはです',
  'cash_on_Delivery' => 'Cash on Delivery',
  'the_following_items_in_your_cart_are_currently_out_of_stock' => 'The following items in your cart are currently out of stock',
  'Please_Login' => 'ロインしてください',
  'You_need_to_login_to_view_this_feature' => 'こ機能を表するにはログンが必です',
  'Delete_this_address' => 'このアドレを削',
  'This_address_will_be_removed_from_this_list' => 'のドレスはこのリストから削除されます',
  ...
  'Total Loyalty Point' => '合計ロイヤルティ ポト',
  'Convert point to wallet money' => 'ポイントをウォレットマネーに変換',
  'Enters Point Amount' => 'ポイント金額を入力',
  'my_Wishlists' => 'My Wishlists',
  'Product_added_to_wishlist' => 'ウィッシュリスト追された製品',
  ...
  'The code has already been taken.' => 'コードはすに取得さています。',
  ...
  'after_uploading_products_you_need_to_edit_them_and_set_products_images_and_choices.' => '製品のアップード後、製品の編集と品の画像と選択の設定が必です。',
  ...
  'The_add_fund_bonus_must_be_a_numeric_value' => '追加資金ボスの必須の数値値',
  ...
  'The_referral_earning_exchange_rate_must_be_a_numeric_value' => '参照収益換レートの必須の数値',
  ...
  'The_maximum_add_fund_amount_must_be_at_least_0' => '追加資金の最大額 須 なくとも 0',
  'The_minimum_add_fund_amount_must_be_a_numeric_value' => '最小追資金額の必須数値値',
  'The_minimum_add_fund_amount_must_be_at_least_0' => '追加資金の小額 必須 少なくとも 0',
  'The_item_purchase_point_must_be_a_numeric_value' => '商購入ポイント数値でなければなりまん',
  'The_item_purchase_point_must_be_at_least_0' => 'The item purchase point must be at least 0',
  'The_minimum_transfer_point_must_be_a_numeric_value' => '最小転送イントは値でなければなりませ',
  'The_minimum_transfer_point_must_be_at_least_0' => '最転送ポイント 必 少くとも 0',
  'Deleted_successfully' => 'Deleted successfully',
  'Product_is_required' => '品は必須です',
  'deal_added_successfully' => 'Deal added successfully',
  'Delete_successfully' => '削除 成功しした',
  'Maintenance_Mode_on' => 'メンテナンスモーオン',
  'shop_Edit' => 'Shop Edit',
  ...
  'Shop_updated_successfully' => '買い物 更 成功しました',
  'Upload_Icon' => 'アップロード イン',
  'all_Stores' => 'すての店舗',
  ...
  'No_review_given_yet' => 'レビューはまありません',
  'no_product_found_in_wishlist' => 'No product found in wishlist',
  'your_payment_has_been_successfully_processed_and_your_order' => 'あたの支払いは正常に処理されあなたの注文完了しまた',
  ...
  'You_will_receive_an_email_confirmation_when_your_order_is_placed.' => '注文が完すると、確メールが届ます。',
  'order_confirmed' => 'Order confirmed',
  'preparing_shipment' => 'Preparing shipment',
  'your_deliveryman_is_coming' => 'Your deliveryman is coming',
  'files_Uploaded' => 'Files Uploaded',
  'Ready product upload must be a file of type: pdf zip jpg jpeg png gif.' => '備ができ製品のアップロードは、pdf zip jpg jpeg png gif のァイル形式である必要があります。',
  ...
  'The_minimum_add_fund_amount_must_be_at_least_1' => '追加資金の最額 必須 少なくとも 1',
  ...
  'you_haven’t_any_conversation_yet' => 'ま会話していません',
  'my_Address' => 'My Address',
  'add_informations' => '情報の加',
  'address_update_successfully' => 'address update 成',
  'all_input_field_required' => 'all input field required',
  'address_updated_successfully!' => 'address updated 成功しし!',
  ...
  'point_To_Wallet' => 'Point To Wallet',
  'refund_Order' => 'Refund Order',
  'Create Your Own Busi' => '独自のビジネスを作成する',
  ...
  'thank_you_for_your_order!' => 'Thank you for your order!',
  'your_order_is_being_processed_and_will_be_completed_within_3_to_6 hours' => 'ご注文処中であり、3 ～ 6 間以に完了する予定す',
  'choose_label' => 'Choose label',
  ...
  'no_Order_Found' => 'No Order Found',
  'you_have_not_placed_any__order_yet' => 'あなたはまだ注文をしていまん',
  'about_our_company' => '私たちの社について',
  'Jhon' => 'ジョン',
  ...
  'Halar' => 'ハラル',
  'Shop-12_Road-8' => 'ョップ-12 道路-8',
  'image_ratio_3:1' => 'Image ratio 3:1',
  'image_ratio_1:1' => 'Image ratio 1:1',
  'Payment status updated' => '支払状況が新されました',
  '1abcdigitaf update' => '1abcdigitalaf更新',
  ...
  'The_brand_has_already_been_taken' => 'ブンはすでに取得されてます',
  ...
  'Payment_must_be_confirmed_first' => '最初に支払い確認する必要がありま',
  'The_OTP_is_incorrect' => 'OTP は正しくありませ',
  ...
  'The_file_must_be_an_image' => 'ファイ必須の画像',
  'company_information' => 'Company information',
  ...
  'don’t_miss_the_chance' => 'Dont miss the chance',
  'today’s_best_deal' => 'Today’s best deal',
  ...
  'Add_Fund_Transaction_Status' => '資金引ステータス追加',
  'Transaction_Successful' => 'トンザクショ 成功',
  'amount_successfully_credited to_your_wallet' => 'Amount successfully credited to your wallet',
  'Thank you for joining with' => 'ご参加いたきありがとございます',
  ...
  'The_ticket_subject_is_required' => 'チットの件名は必須です',
  'The_ticket_type_is_required' => 'The ticket type is required',
  'The_ticket_priority_is_required' => 'The ticket priority is required',
  'Either_a_ticket_description_or_an_image_is_required' => 'チケットの説明た画像のいずれかが必要す',
  'The_file_must_be_of_type:_jpeg _png _jpg _gif' => 'イルの種類:jpeg png jpg gif',
  'The_image_must_not_exceed_6_MB' => '画像は6 MBをえはいけません',
  'submission_date' => 'Submission date',
  'all_transactions' => 'All transactions',
  'all_transaction' => 'すべてのトランクション',
  'my_Compare_List' => 'My Compare List',
  'my_Loyalty_Point' => 'My Loyalty Point',
  ...
  'Brand is required!' => 'ブンドは必須です',
  'Name field is required!' => '名前フィールドは必須です!',
  'Code must be minimum 6 digits!' => 'コードは少なくも 6 桁である要がありす。',
  'contact_information_table' => 'Contact information table',
  ...
  'New_Currency_inserted_successfully' => '新しい 通貨 入 成功しまた',
  ...
  'Mail_sent_successfully' => 'メール送信成功',
  'Feedback_Update_successfully' => 'フィードバック 更新 成功しました',
  ...
  'Vacation_mode_updated_successfully' => '休暇モド更成功',
  ...
  'Page_Expired' => 'ページ 期限切れ',
  'Please update product code!' => 'プロダクトコーを新してください。',
  ...
  'Maintenance_is_on' => 'メンテナス中です',
  'Maintenance_is_off' => 'メンテナンスオフです',
  ...
  'not exist' => 'Not exist',
  'Yamsung Galaxy M51 (' => 'サムスン ギャラクシ M51 (',
  535 => '535',
  'MCU47V593M' => 'MCU47V593M',
  'Promo Banner Bottom' => 'プロモション バナー下部',
  ...
  'Ready product upload is required!' => '準備がきた製品のアッローが必要です。',
  'refunded_request_updated_successfully!!' => 'Refunded request updated successfully!!',
  'already_applied_for_refund_request!!' => 'でに返金リクエスト請済みです!!',
  ...
  'Invalid Chatting Type!' => 'チャットの種類無効です!',
  'most_Rated_products' => 'Most Rated products',
  'Theme Changed to Theme Testing' => 'テーマがテーマテトに変更されました',
  ...
  'The code field is required.' => 'コードフィールドは必です。',
  'Color_images_is_required' => 'カラーメーは必須です',
  'Color images is required' => 'ラー画像は必須です',
  'order_delivery_verification' => 'Order delivery verification',
  'show_billing_address_in_checkout' => 'Show billing address in checkout',
  'free_delivery_responsibility' => 'Free delivery responsibility',
  'free_delivery_over' => 'Free delivery over',
  ...
  'Language_name_field_is_required!' => '言語名フィルドは必です!',
  'Language_updated' => 'Language updated',
  'ex-1246778123456' => 'Ex-1246778123456',
  1234567890 => '1234567890',
  'want_to_cancel_this_order ' => 'Want to cancel this order ',
  'VR_collection' => 'VR コレクション',
  '3rd_Party' => 'サードパーティ',
  'withdrawal_methods' => 'Withdrawal methods',
  ...
  'Send_Message_to_vendor' => 'ベダーにメッセジを送信',
  'All_vendor_Page' => 'べてのベンダーページ',
  'Find_your_desired_stores_and_shop_your_favourite_products' => '希望の店舗を見つけお気に入りの商品購入する',
  'vendor' => 'Vendor',
  'chatting' => 'Chatting',
  'payment_none' => 'Payment none',
  'contact_with_vendor' => 'Contact with vendor',
  'Chat_with_vendor' => 'ベンダーチャット',
  'all_Brands_Page' => 'すべてのブランページ',
  ...
  'add_color_wise_product_images_here' => 'ここにカラーごと製品画像を追加',
  ...
  'Cloud_Messaging' => 'クラウドメッセジング',
  'tab_from_the_top_menu' => 'Tab from the top menu',
  'obtain_all_the_information_asked' => 'Obtain all the information asked',
  'In_the_Firebase_Project_settings_page _click_on_the_ General _tab_from_the_top_menu' => 'Firebase のプロェト設定ページ内で上部メニューの [全般] タブクリックします',
  'under_the' => 'Under the',
  'Your_Apps' => 'あなたのプリ',
  'section' => 'Section',
  'WEB' => 'ウェブ',
  ...
  'API_Key' => 'API キー',
  'Auth_Domain' => '証ドメイン',
  'Storage_Bucket' => 'ストレジ バケット',
  'Messaging_Sender_ID' => 'メッセージグ 送信者 ID',
  ...
  'The_last_name_field_is_required' => 'のィールドは必須です',
  'The_phone_field_is_required' => '電話番号フィール必須です',
  'The_email_field_is_required' => '電子メフィールドは必須で',
  'The_email_has_already_been_taken' => 'メールアドレスはすでに取得されてます',
  'The_country_code_field_is_required' => '国コーフィードは必須です',
  'The_password_field_is_required' => 'The password field is required',
  'The_password_and_confirm_password_must_match' => 'スワード確認パスワードは一致する必要がります',
  'The_password_must_be_at_least :min_characters' => 'パスワードの必須条は少なくとも :min characters',
  'want_to_add_this_delivery_man' => 'Want to add this delivery man',
  'The_image_field_is_required' => '画フィードは必須です',
  'The_image_type_must_be' => '像の類は必須です',
  'The first name field is required' => 'The first name field is required',
  'The last name field is required' => '姓フィールは必須です',
  'The phone field is required' => '電話号ィールドは必須です',
  'The image field is required' => '画像フィールドはです',
  'The password and confirm password must match' => 'The password and confirm password must match',
  'delivery_man_added_successfully' => 'Delivery man added successfully',
  'The phone has already been taken.' => '電話はすでに取られいます。',
  'The email has already been taken' => 'メーはでに取られています',
  ...
  'Already_have_account ' => 'すでにアカウントをおちです',
  ...
  'You_need_to_Sign_in_to_view_this_feature' => 'この機能を表するにはサインンが必要です',
  'Please_Sign_in' => 'サインインしくださ',
  'vendor_Login' => 'Vendor Login',
  ...
  'The password and confirm password must match.' => 'パスードと確用パスワードは一致す必要があます。',
  'delivery_man_updated_successfully' => 'Delivery man updated successfully',
  'The_password_and_confirm_password_must_be_match' => 'パスワーとパスワード確認は一致する必要がりま',
  'earning_history' => 'Earning history',
  'Cash in Hand' => '手持ちの現金',
  'withdraw_information_View' => 'Withdraw information View',
  'vendor_withdraw_information' => 'Vendor withdraw information',
  'The_confirm_password_field_is_required' => 'パスワード確認フールドは必須です',
  'The password and confirm password must be match' => 'パスドと確認用パスワード一致する必要がありま',
  ...
  'employee' => 'Employee',
  'The_type_is_required' => 'イプは必須です',
  'The_url_is_required' => 'URLは必です',
  'column' => 'Column',
  ...
  'not_sent' => 'Not sent',
  'not_seen_yet' => 'Not seen yet',
  'Variation Wise Price' => 'バリエーショワイズライス',
  'Stock' => 'スック',
  ...
  'The_id_field_is_required' => 'id field is required',
  ...
  'Delivery_Available_Zip_Code_Area' => 'Delivery Available Zip Code Area',
  'Enter_Zip_Code' => '郵便番号を入',
  'of_the_country_you’ve_selected' => 'Of the country youve selected',
  ...
  'If_only_theDelivery_Available_Country’feature_is_enabled _and_you_add_your_preferred_country _then_youll_be_able_to_deliver_all_over_the_country' => '「配達可な国」機能のが有効あり、ご希望の国を追加した場合、そ国全に配達可能になりす',
  'If_only_the‘Delivery_Available_Zip_Code_Area’feature_is_enabled _then_you’ll_be_able_to_deliver_on_all_the_zip_code_areas' => 'If only the‘Delivery Available Zip Code Areafeature is enabled  then you’ll be able to deliver on all the zip code areas',
  ...
  'Please_Note' => 'ご注意くさ',
  'If_you_don’t_enter_a_specific_zip_code_from_a_country _that_area_won’t_be_available_for_delivery' => '特定の国の郵便番号を入力しな、その地域では配達がなくなります',
  ...
  'If_only_the ‘Delivery_Available_Zip_Code_Area’ feature_is_enabled _then_you’ll_be_able_to_deliver_on_all_the_zip_code_areas' => '「配達可能な郵便番エア」機能のみが有効な場合、すべての郵番号リアで配達が可になりす',
  'payment_method_name' => 'Payment method name',
  'input_data' => 'Input data',
  'AVC_bank' => 'AVC バク',
  'is_required' => 'Is required',
  ...
  'according_to_your_payment_method' => '支払い方法に応じて',
  'Required_Information_from_Customer' => 'お客様からの必須情報',
  ...
  'The two-in-one benefits of ‘Offline Payment Method’ Feature:' => '「オライン支払い方法」機能の 2 つのリットを 1 にまとめもの:',
  ...
  'required_information_from_Customer' => 'Required information from Customer',
  'add_relevant_input_fields_for_customers_to_fill-up_after_completing_the_offline_payment' => 'オフライン支い完了後の顧客けの連入力フィールド追加',
  ...
  'SendGrid_Configuration_updated_successfully' => 'SendGrid Configuration updated successly',
  'Mail_Sent_Unsuccessful' => 'メー送信 失敗',
  ...
  'add_the_Android_app_download_URL_that_will_redirect_users_when_they_agree_to_update_the_app' => 'add the Android app download URL that that will redirect users when they agree to update the app',
  ...
  'Finally _click_‘Update_to_save_the_changes' => '最に更新」をクリックして更を保存します',
  ...
  'The_title_field_is_required.' => 'タトルフィールドは必須す。',
  'The_bonus_type_field_is_required.' => 'ボナスイプフィールドは必須す。',
  'The_bonus_amount_field_is_required.' => 'The bonus amount field is required.',
  'The_bonus_amount_must_be_a_numeric_value.' => 'ボース金額数値でなければなりまん。',
  'The_bonus_amount_must_be_at_least_0.01.' => 'ボナス額は少なくとも 0.01 でなければりません。',
  'The_minimum_add_money_amount_field_is_required.' => '最追加金額フィールドは須です。',
  'The_minimum_add_money_amount_must_be_a_numeric_value.' => 'The minimum add money amount must be a numeric value.',
  'The_minimum_add_money_amount_must_be_at_least_0.01.' => '最小追加額は少なくも 0.01 でなければなりせん。',
  'The_start_date_and_time_field_is_required.' => '開始日と時刻のフィードは必です。',
  ...
  'Update_Addresses' => 'Update Addresses',
  'you_need_to_select_address_from_your_selected_country' => '選択た国の住所を選する必要があります',
  ...
  'The_approved_note_field_is_required' => '「approved note field is required」',
  'The_rejected_note_field_is_required' => '拒否されたメモのフールドは必須です',
  'The rejected note field is required' => '拒否されたメィールドは必須です',
  'The approved note field is required' => '承認済みのメ欄は必須です',
  ...
  'The_payment_method_field_is_required' => '支払い方法フィールは必須です',
  ...
  'already_have_an_account' => 'すでにアカウント持ちですか',
  ...
  'The_selected_customer_does_not_exist' => '選択さた客は存在しません',
  'The_amount_must_be_a_numeric_value' => 'The amount must be a numeric value',
  'The_amount_must_be_at_least_0.01' => '最 0.01以上の金額が必要す',
  'The_amount_cannot_exceed_10000000' => '10000000を超えることできない金',
  '_fund_added' => ' fund added',
  'Reward_by_company_admin' => '会社管者による酬',
  ...
  'Identity is required!' => '身分証書が必要です!',
  ...
  'Upload_Offer_Banner' => 'Upload Offer Banner',
  'required_information_from_customer' => 'Required information from customer',
  'Please_re-check_if_you’ve_put_all_the_data_correctly_or_contact_your_SMS_gateway_provider_for_assistance' => 'すべてのデータを正し入したかどうかを再確認るか、SMS ゲートウェ プロバイダーに問い合せてサポートを依頼てださい',
  'Terms_and_Condition_Updated_successfully' => '用規約が正常に更されました',
  'Privacy_policy_Updated_successfully' => 'プラバシー ポリシー 更新 功しました',
  'the_value_field_is_required' => 'The value field is required',
  'about_us_updated_successfully' => 'about us updated successly',
  'edit_modal_help_topic' => 'Edit modal help topic',
  ' youll_get_a_mail_soon' => 'すぐメールが届きます',
  ...
  '_you_cannot_change_the_status_again' => 'ステタスを再度更することはできません',
  ...
  'Environment_Settings' => '環境 設定',
  'Analytic_Scripts' => '析スクリト',
  'site_Map' => 'Site Map',
  'OTP_&_Login_Attempts' => 'OTP & Login Attempts',
  'login_Url' => 'Login Url',
  'OTP_resend_time_' => 'OTP 送信 時間',
  ...
  'then_you_won’t_able_change_any_status' => 'Then you wont able change any status',
  'want_to_refund_this_refund_request' => 'Want to refund this refund request',
  'The_denied_note_field_is_required' => '否さたメモのフィールドは必須です',
  ...
  'you_have_already_changed_' => 'あたすでに変更されてい ',
  ...
  'you_have_already_' => 'あなたは すでに持っます',
  ...
  'total_Deliveryman_Incentive' => 'Total Deliveryman Incentive',
  'Download_PDF' => 'ダウンロード PDF',
  'Email already has been taken' => 'ーはすでに取られてます',
  ...
  'Do you want to sign out' => 'サインアウトしますか?',
  'Are you sure you want to sign out Confirm to Sign out' => 'サインアウトしてもよしいです? サインアトを確認しください',
  ...
  'Shipping Cost is required!' => '料は必要です！',
  'Code is required!' => 'コードは必須です!',
  'The minimum order quantity is required!' => '最低注文量が必要です!',
  'The minimum order quantity must be positive!' => '最小注文数量正の値である必があます。',
  ...
  'The_identity_image_type_must_be' => 'ID メージのタイプは必須す',
  'Failed to Deliver' => '配信に失敗しました',
  'Vendor_Payment_request_has_been_Denied_successfully' => 'Vendor Payment request has been Denied Continuously',
  'Vendor_Payment_has_been_approved_successfully' => 'Vendor Payment has been approved successly',
  ...
  '_products_under_this_category' => 'このテゴリの 製品',
  ...
  '_to_know_more_details' => '詳細を知は',
  'do_not_miss_todays_deal' => 'Do not miss todays deal',
  '_and_no_spaces' => 'スーなし',
  'The password field is required' => 'パスードフィールドは必須す',
  'Contact_Us' => 'おい合わせ',
  '_one_special_character' => '殊文字 1 ',
  '_one_digit_' => '一桁',
  '_one_lowercase_letter' => '文字 1 文字',
  'Customer_Added_Successfully' => '顧客 加 成功',
  ...
  'your_registration_is_successful' => 'あなの登録は成功しまし',
  'company_reliability_choose_your_product_title' => '製品を選択してください',
  'company_reliability_choose_your_product_description' => '当社が提供する何千もの製品をご覧ください。',
  'company_reliability_more_products_title' => 'より多くの製品、より多くのメリット',
  'company_reliability_more_products_description' => '各販売者がボリューム別に提供するプロモーションをお楽しみください。',
  'company_reliability_track_your_order_title' => '注文を常に追跡',
  'company_reliability_track_your_order_description' => '安心して購入でき、いつでもどこにあるかを確認できます。',
);